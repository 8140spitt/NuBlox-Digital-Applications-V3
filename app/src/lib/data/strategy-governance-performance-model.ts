...
export const strategyGovernancePerformanceModel: StrategyGovernancePerformanceDefinition[] = [
  sgp(
    ...
    [
      'Strategy Framework is not merely a document.',
      'Approved versions remain reconstructable.',
      'Objectives, themes, initiatives, plans and performance evidence retain separate identities.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Objective is not KPI Definition, Target or Performance Observation.',
      'Objective may be supported by many initiatives.',
      'Achievement is evidenced by governed performance/review records rather than a manually asserted status alone.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Theme is not an Organisation Unit or reporting-only tag.',
      'Theme does not replace Objective or Initiative identity.',
      'Membership changes preserve strategy-version context.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Strategic Initiative is not automatically a Project or Programme.',
      'Delivery identities are explicitly linked when created.',
      'Strategic outcome ownership survives delivery-vehicle changes.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Business Plan is not Budget or Forecast truth although it references them.',
      'Approved plan versions remain immutable comparison points.',
      'Changes link to exact assumptions/decisions.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Scenario is planning context, not Forecast Snapshot.',
      'Scenarios may share assumptions.',
      'Scenario changes never rewrite decisions already made against earlier versions.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Assumption is not a fact or observation.',
      'Consumers pin exact assumption/version.',
      'Invalidation does not rewrite prior analyses/decisions.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'KPI Definition is not an observed value.',
      'Formula/unit changes create successor definitions or versions.',
      'Source-system identifiers do not replace canonical KPI identity.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Target is planned expectation, not actual performance.',
      'Target changes never overwrite historical performance observations.',
      'Carbon and other specialist targets may link to this enterprise performance layer without losing specialist semantics.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Observation is source evidence, not Snapshot or Target.',
      'Corrections create explicit successor/correction evidence.',
      'Derived dashboards never become authoritative observations.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Snapshot is not source observation truth.',
      'Published snapshots are reproducible from pinned inputs.',
      'Subsequent observations/corrections do not silently rewrite issued snapshots.'
    ]
  ),

  sgp(
    'SGP-STRATEGIC-REVIEW',
    ['BOF-02-012'],
    'Strategic Review',
    'event-evidence',
    ...
    [
      ...
      'Review findings remain evidence and trigger explicit decisions/actions.',
      'Prior reviews remain immutable historic governance evidence.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Governance Body is not Organisation Unit or Team.',
      'Membership does not itself grant every decision authority.',
      'Actual authority is evaluated through Authority Framework, role and Delegated Authority.'
    ]
  ),
  ...
  sgp(
    ...
    [
      ...
      'agenda',
      'papers',
      'minutes/governance record'
    ],
    ['Scheduled', 'Convened', 'Adjourned', 'Completed', 'Cancelled'],
    [
      'Meeting is not Governance Body.',
      'Presence is not authority.',
      'Decisions and actions remain separately governed immutable/business-work records.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Agenda Item is not Decision or Action.',
      'Exact papers/versions are retained.',
      'Deferral/reconsideration remains traceable.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Governance Decision reuses shared Decision.',
      'Meeting minutes do not substitute for structured Decision evidence.',
      'Decision does not itself become the changed domain object.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Action reuses shared Decision Action.',
      'Workflow Work Item may coordinate it but never replaces business action truth.',
      'Completion does not rewrite source Decision.'
    ]
  ),
  ...
  sgp(
    ...
    [
      'Policy content reuses Information Container.',
      'Machine-enforced configuration may implement policy but is not the policy record itself.',
      'Historic effective policy revisions remain reconstructable.'
    ]
  ),
  ...
  sgp(
    ...
    ['Draft', 'Review', 'Approved', 'Effective', 'Superseded', 'Retired'],
    [
      'Authority Framework is not Delegated Authority.',
      'Permission, role, assignment and delegated authority remain separate.',
      'Historic decisions retain exact authority framework/grant basis.'
    ]
  ),

  sgp(
    'SGP-GOVERNANCE-RECORD',
    ['BOF-02-020'],
    'Governance Record',
    'shared-reference',
    ...
    [
      'Information Container',
      'record type',
      'meeting/body/context',
      'approved revision',
      'sign-off/issue',
      'classification',
      'record declaration/retention'
    ],
    ['Draft', 'Review', 'Approved', 'Issued', 'Superseded', 'Archived'],
    [
      'Governance Record reuses Information Container.',
      'Structured Meeting/Decision/Action truth remains separate from minutes/document narrative.',
      'Records-management classification overlays the same authoritative information identity.'
    ]
  )
];
...
export const strategyGovernancePerformanceRelationships: StrategyGovernancePerformanceRelationship[] =
  [
    {
      id: 'SGP-R01',
      from: 'SGP-STRATEGY-FRAMEWORK',
      predicate: 'contains',
      to: 'SGP-STRATEGIC-THEME',
      cardinality: 'one-to-many',
      governance: 'Theme identity/version remains explicit.'
    },
    {
      id: 'SGP-R02',
      from: 'SGP-STRATEGY-FRAMEWORK',
      predicate: 'defines',
      to: 'SGP-STRATEGIC-OBJECTIVE',
      cardinality: 'one-to-many',
      governance: 'Objectives retain independent ownership and lifecycle.'
    },
    {
      id: 'SGP-R03',
      from: 'SGP-STRATEGIC-THEME',
      predicate: 'groups',
      to: 'SGP-STRATEGIC-OBJECTIVE',
      cardinality: 'many-to-many',
      governance: 'Grouping never replaces objective identity.'
    },
    {
      id: 'SGP-R04',
      from: 'SGP-STRATEGIC-INITIATIVE',
      predicate: 'supports',
      to: 'SGP-STRATEGIC-OBJECTIVE',
      cardinality: 'many-to-many',
      governance: 'Strategic benefit/outcome linkage remains explicit.'
    },
    {
      id: 'SGP-R05',
      from: 'SGP-BUSINESS-PLAN',
      predicate: 'operationalises',
      to: 'SGP-STRATEGIC-OBJECTIVE',
      cardinality: 'many-to-many',
      governance: 'Plan pins objective/version context.'
    },
    {
      id: 'SGP-R06',
      from: 'SGP-BUSINESS-PLAN',
      ...
      cardinality: 'many-to-many',
      governance: 'Initiative identity survives plan revisions.'
    },
    {
      id: 'SGP-R07',
      from: 'SGP-SCENARIO',
      ...
      to: 'SGP-ASSUMPTION',
      cardinality: 'many-to-many',
      governance: 'Exact assumption/version is retained.'
    },
    {
      id: 'SGP-R08',
      from: 'SGP-BUSINESS-PLAN',
      ...
      to: 'SGP-ASSUMPTION',
      cardinality: 'many-to-many',
      governance: 'Planning basis remains challengeable and reproducible.'
    },
    {
      id: 'SGP-R09',
      from: 'SGP-KPI-DEFINITION',
      predicate: 'measures',
      to: 'SGP-STRATEGIC-OBJECTIVE',
      cardinality: 'many-to-many',
      governance: 'Metric meaning remains separate from objective.'
    },
    {
      id: 'SGP-R10',
      from: 'SGP-PERFORMANCE-TARGET',
      predicate: 'targets',
      to: 'SGP-KPI-DEFINITION',
      cardinality: 'many-to-one',
      governance: 'Target pins exact KPI/version.'
    },
    {
      id: 'SGP-R11',
      from: 'SGP-PERFORMANCE-OBSERVATION',
      predicate: 'observes',
      to: 'SGP-KPI-DEFINITION',
      cardinality: 'many-to-one',
      governance: 'Observation pins exact KPI/version and scope.'
    },
    {
      id: 'SGP-R12',
      from: 'SGP-PERFORMANCE-SNAPSHOT',
      predicate: 'derived from',
      to: 'SGP-PERFORMANCE-OBSERVATION',
      cardinality: 'many-to-many',
      governance: 'Snapshot remains reproducible from retained observations.'
    },
    {
      id: 'SGP-R13',
      from: 'SGP-PERFORMANCE-SNAPSHOT',
      predicate: 'compares against',
      to: 'SGP-PERFORMANCE-TARGET',
      cardinality: 'many-to-many',
      governance: 'Actual and target remain distinct.'
    },
    {
      id: 'SGP-R14',
      from: 'SGP-STRATEGIC-REVIEW',
      predicate: 'reviews',
      to: 'SGP-STRATEGY-FRAMEWORK',
      cardinality: 'many-to-one-or-many',
      governance: 'Exact strategy versions are pinned.'
    },
    {
      id: 'SGP-R15',
      from: 'SGP-STRATEGIC-REVIEW',
      predicate: 'uses',
      to: 'SGP-PERFORMANCE-SNAPSHOT',
      cardinality: 'many-to-many',
      governance: 'Review basis retains exact issued snapshot.'
    },
    {
      id: 'SGP-R16',
      from: 'SGP-GOVERNANCE-MEETING',
      predicate: 'convened by',
      to: 'SGP-GOVERNANCE-BODY',
      cardinality: 'many-to-one',
      governance: 'Body identity persists across meetings.'
    },
    {
      id: 'SGP-R17',
      from: 'SGP-GOVERNANCE-MEETING',
      ...
      to: 'SGP-AGENDA-ITEM',
      cardinality: 'one-to-many',
      governance: 'Agenda item is subordinate to meeting.'
    },
    {
      id: 'SGP-R18',
      from: 'SGP-AGENDA-ITEM',
      predicate: 'may result in',
      to: 'WORK-DECISION',
      cardinality: 'one-to-zero-or-many',
      governance: 'Decision remains shared immutable evidence.'
    },
    {
      id: 'SGP-R19',
      from: 'WORK-DECISION',
      ...
      cardinality: 'one-to-many',
      governance: 'Action remains separately owned and evidenced.'
    },
    {
      id: 'SGP-R20',
      from: 'SGP-GOVERNANCE-BODY',
      predicate: 'governed by',
      to: 'SGP-AUTHORITY-FRAMEWORK',
      cardinality: 'many-to-one-or-many',
      governance: 'Applicable authority rules/effectivity are explicit.'
    },
    {
      id: 'SGP-R21',
      from: 'SGP-AUTHORITY-FRAMEWORK',
      predicate: 'governs grants of',
      to: 'AUTH-DELEGATED-AUTHORITY',
      cardinality: 'one-to-many',
      governance: 'Framework/rule and specific grant remain separate.'
    },
    {
      id: 'SGP-R22',
      from: 'SGP-POLICY',
      ...
      governance: 'Policy identity/revision remains controlled information.'
    },
    {
      id: 'SGP-R23',
      from: 'SGP-GOVERNANCE-RECORD',
      predicate: 'reuses',
      to: 'CBO-INFORMATION-CONTAINER',
      cardinality: 'many-to-one-pattern',
      governance: 'Governance record is controlled information representation.'
    },
    {
      id: 'SGP-R24',
      from: 'SGP-STRATEGIC-INITIATIVE',
      ...
      governance: 'Programme delivery does not replace strategic initiative.'
    },
    {
      id: 'SGP-R25',
      from: 'SGP-STRATEGIC-INITIATIVE',
    ...
    },
    {
      ...
      to: 'DEL-PORTFOLIO',
      cardinality: 'many-to-zero-or-many',
      governance: 'Portfolio is governance/investment context, not initiative identity.'
    }
  ];
...
export function validateStrategyGovernancePerformanceModel() {
  ...
  if (
    ids.size !== strategyGovernancePerformanceModel.length ||
    relIds.size !== strategyGovernancePerformanceRelationships.length
  )
    return false;
  const candidates = new Set(strategyGovernancePerformanceModel.flatMap((x) => x.candidateKeys));
  for (let i = 1; i <= 20; i += 1)
    if (!candidates.has(`BOF-02-${String(i).padStart(3, '0')}`)) return false;
  if (
    strategyGovernancePerformanceModel.some(
      (x) => !x.definition || !x.identityRule || !x.governance.length
    )
  )
    return false;
  return strategyGovernancePerformanceRelationships.every(
