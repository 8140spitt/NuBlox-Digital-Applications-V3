...
export type PositionFunctionAssignmentId = Brand<string, 'PositionFunctionAssignmentId'>;
export type PositionReportingLineId = Brand<string, 'PositionReportingLineId'>;
export type JobFamilyId = Brand<string, 'JobFamilyId'>;
export type JobSubfamilyId = Brand<string, 'JobSubfamilyId'>;
export type CareerLevelId = Brand<string, 'CareerLevelId'>;
export type GradeId = Brand<string, 'GradeId'>;
export type JobProfileArchitectureAssignmentId = Brand<string, 'JobProfileArchitectureAssignmentId'>;
...
export type ConfigurationEnvironmentId = Brand<string, 'ConfigurationEnvironmentId'>;
export type ConfigurationBaselineId = Brand<string, 'ConfigurationBaselineId'>;
export type ConfigurationBaselineItemId = Brand<string, 'ConfigurationBaselineItemId'>;
export type ConfigurationChangeSetId = Brand<string, 'ConfigurationChangeSetId'>;
export type ConfigurationChangeItemId = Brand<string, 'ConfigurationChangeItemId'>;
export type ConfigurationPromotionRunId = Brand<string, 'ConfigurationPromotionRunId'>;
export type ConfigurationPromotionItemResultId = Brand<string, 'ConfigurationPromotionItemResultId'>;
export type ConfigurationPromotionConflictId = Brand<string, 'ConfigurationPromotionConflictId'>;
export type ConfigurationPromotionConflictDispositionId = Brand<string, 'ConfigurationPromotionConflictDispositionId'>;
export type RetentionPolicyId = Brand<string, 'RetentionPolicyId'>;
export type RetentionRuleId = Brand<string, 'RetentionRuleId'>;
export type HoldId = Brand<string, 'HoldId'>;
export type DispositionScheduleId = Brand<string, 'DispositionScheduleId'>;
export type DispositionRunId = Brand<string, 'DispositionRunId'>;
export type DispositionItemResultId = Brand<string, 'DispositionItemResultId'>;
export type ArchiveRecordId = Brand<string, 'ArchiveRecordId'>;
export type RestoreRunId = Brand<string, 'RestoreRunId'>;
export type DestructionEvidenceId = Brand<string, 'DestructionEvidenceId'>;
export type SupplierRelationshipId = Brand<string, 'SupplierRelationshipId'>;
export type SourcingContextId = Brand<string, 'SourcingContextId'>;
export type SourceApprovalId = Brand<string, 'SourceApprovalId'>;
export type SourcingRuleId = Brand<string, 'SourcingRuleId'>;
export type ProjectionCheckpointId = Brand<string, 'ProjectionCheckpointId'>;
export type SalesAccountId = Brand<string, 'SalesAccountId'>;
export type SalesOpportunityId = Brand<string, 'SalesOpportunityId'>;
...
export type OrganisationalContextId = Brand<string, 'OrganisationalContextId'>;
export type OrganisationalResourceRequirementId = Brand<string, 'OrganisationalResourceRequirementId'>;
export type OrganisationalResourceFulfilmentId = Brand<string, 'OrganisationalResourceFulfilmentId'>;
...
export type SiteWorkPackageId = Brand<string, 'SiteWorkPackageId'>;
export type SiteDailyLogId = Brand<string, 'SiteDailyLogId'>;
export type SiteProgressRecordId = Brand<string, 'SiteProgressRecordId'>;
export type SiteFieldEvidenceId = Brand<string, 'SiteFieldEvidenceId'>;
export type SiteIssueId = Brand<string, 'SiteIssueId'>;
