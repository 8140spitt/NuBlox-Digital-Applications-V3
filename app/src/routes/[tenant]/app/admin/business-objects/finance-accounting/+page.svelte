...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed ledger, AP/AR, settlement, tax, fixed-asset accounting, treasury and
        project-financial-control semantics. Finance records financial effects while reusing the
        same enterprise business identities.
      </p>
    </div>
    <div class="hero-actions">
      ...
      >
      <a href={`/${data.tenantSlug}/app/admin/business-objects/asset-operations`}
        >Asset operations</a
      >
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed financial constructs</h2>
      </div>
      <p>
        Each construct defines identity, scope and lifecycle while preserving the boundary between
        business truth, accounting evidence and derived financial positions.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How finance references enterprise truth</h2>
      </div>
      <p>
        Posting and reporting dimensions point back to canonical legal, commercial, project and
        asset identities instead of reproducing them inside Finance.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each financeAccountingRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
...
<style>
  ...
  .hero {
    ...
    align-items: center;
    padding: 20px;
    background: linear-gradient(120deg, #fbfdff, #f5f4ec 65%, #fff);
  }
  .eyebrow {
    color: var(--blue-700);
    font-size: 10px;
