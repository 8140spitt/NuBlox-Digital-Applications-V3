...
export const peopleHcmRelationships: PeopleHcmRelationship[] = [
  ...
  { id: 'HCM-AVAILABILITY', from: 'HCM-AVAILABILITY', predicate: 'projects availability of', to: 'HCM-PERSON', cardinality: 'many-to-one', governance: 'Availability is calculated from authoritative source records.' },
