...
export const riskComplianceAuditModel: RiskComplianceAuditDefinition[] = [
  rca(
    ...
    [
      'Framework is configuration and governance, not an Enterprise Risk.',
      'Historic assessments retain exact framework/method version.',
      'Risk appetite/tolerance changes never rewrite prior decisions.'
    ]
  ),
  ...
  rca(
    ...
    [
      ...
      'category',
      'affected objectives/scope',
      'owner',
      'status'
    ],
    ['Identified', 'Active', 'Treating', 'Monitoring', 'Accepted', 'Closed'],
    [
      'Risk identity is not its current rating.',
      'Climate, resilience, project, cyber and other specialisations reuse this pattern where appropriate.',
      'Closing a Risk does not delete assessment/treatment history.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Assessment is not Risk identity.',
      'Reassessment creates new evidence rather than overwriting prior ratings.',
      'QHSE and other domains reuse this pattern.'
    ]
  ),
  ...
  rca(
    ...
    [
      ...
      'owners',
      'dates',
      'resources/cost context',
      'approval'
    ],
    ['Draft', 'Review', 'Approved', 'Active', 'Completed', 'Superseded', 'Cancelled'],
    [
      'Treatment Plan is not Risk Assessment.',
      'Completion of actions does not automatically close Risk without reassessment/decision.',
      'Actions may be coordinated by Work Items but remain domain-owned.'
    ]
  ),

  rca(
    'COMP-REGULATORY-OBLIGATION',
    ['BOF-21-005'],
    ...
    [
      'Obligation is source legal/regulatory duty, not proof of compliance.',
      'Amendment/effectivity history must remain reconstructable.',
      'One obligation may generate multiple actionable Compliance Requirements.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Requirement is distinct from source Obligation and from compliance evidence.',
      'QHSE and other domains reuse this pattern.',
      'Applicability is governed explicitly rather than copied into local registers.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Assessment is evidence, not the Compliance Requirement.',
      'A live compliance dashboard is a projection over retained assessments/evidence.',
      'Assessment conclusions must remain reproducible from exact requirement/evidence versions.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Control definition is not a Control Test or evidence occurrence.',
      'Ownership/performance assignment does not itself confer authority.',
      'Material control changes preserve version history.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Control Test is not the Internal Control.',
      'Retesting creates a new occurrence.',
      'Exceptions may create Findings or Remediation Actions without rewriting test evidence.'
    ]
  ),

  rca(
    'ASSURANCE-PLAN',
    ['BOF-21-010', 'BOF-21-011'],
    'Assurance Plan',
    'plan',
    ...
    [
      ...
      'Plan items do not become Audit Engagements until explicitly instantiated.',
      'Risk-based planning retains source Risk/Assessment basis.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Audit Engagement is execution, not Assurance Plan.',
      'Evidence and Findings remain separately governed.',
      'Closure does not delete unresolved Remediation Actions.'
    ]
  ),
  ...
  rca(
    ...
    [
      'Finding is not the Audit Engagement.',
      'Finding may relate to Risk, Control or Compliance Requirement without replacing them.',
  ...
  rca(
    ...
    [
      'Remediation Action is domain truth, not a workflow Work Item.',
      'Work Items may coordinate the action.',
      'Verification remains separate from self-reported completion.'
    ]
  ),

  rca(
    'INTEGRITY-CASE',
    ['BOF-21-015', 'BOF-21-016'],
    'Integrity Case',
    'case',
    ...
    [
      'Fraud and Conduct share one case architecture while retaining type-specific rules.',
      'Restricted access and need-to-know controls are mandatory.',
      'Case state never substitutes for employment/legal/criminal outcomes in other domains.'
    ]
  ),
  ...
  rca(
    ...
    [
      ...
      'captured/issued date',
      'validity',
      'provenance',
      'verified by/at',
      'information/evidence references'
    ],
    ['Captured', 'Verified', 'Effective', 'Expired', 'Superseded/Invalidated'],
    [
      'Evidence is not the Requirement or Compliance Assessment.',
      'Documents/files may represent evidence but do not replace structured provenance.',
      'Expired/superseded evidence remains historically queryable.'
    ]
  )
];
...
export const riskComplianceAuditRelationships: RiskComplianceAuditRelationship[] = [
  {
    id: 'RCA-R01',
    from: 'RISK-ENTERPRISE-RISK',
    predicate: 'governed by',
    to: 'RISK-FRAMEWORK',
    cardinality: 'many-to-one-or-many',
    governance: 'Risk interpretation retains applicable framework/version.'
  },
  {
    id: 'RCA-R02',
    ...
    governance: 'Current rating is derived from retained assessments.'
  },
  {
    id: 'RCA-R03',
    ...
    to: 'RISK-ENTERPRISE-RISK',
    cardinality: 'many-to-one',
    governance: 'Treatment lifecycle remains separate from Risk identity.'
  },
  {
    id: 'RCA-R04',
    from: 'RISK-TREATMENT-PLAN',
    ...
    governance: 'Actions remain individually owned and evidenced.'
  },
  {
    id: 'RCA-R05',
    from: 'COMP-REGULATORY-OBLIGATION',
    predicate: 'gives rise to',
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Actionable requirements retain source-obligation provenance.'
  },
  {
    id: 'RCA-R06',
    from: 'COMP-ASSESSMENT',
    predicate: 'assesses',
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Exact requirement versions are retained.'
  },
  {
    id: 'RCA-R07',
    from: 'COMP-ASSESSMENT',
    ...
    to: 'COMP-EVIDENCE',
    cardinality: 'many-to-many',
    governance: 'Assessment result remains reproducible from source evidence.'
  },
  {
    id: 'RCA-R08',
    from: 'CTRL-INTERNAL-CONTROL',
    predicate: 'may satisfy',
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Control mapping is explicit and effective-dated.'
  },
  {
    id: 'RCA-R09',
    from: 'CTRL-INTERNAL-CONTROL',
    predicate: 'may mitigate',
    to: 'RISK-ENTERPRISE-RISK',
    cardinality: 'many-to-many',
    governance: 'Control-to-risk mapping does not change either identity.'
  },
  {
    id: 'RCA-R10',
    from: 'CTRL-CONTROL-TEST',
    predicate: 'tests',
    to: 'CTRL-INTERNAL-CONTROL',
    cardinality: 'many-to-one',
    governance: 'Test references exact control version.'
  },
  {
    id: 'RCA-R11',
    from: 'ASSURANCE-PLAN',
    predicate: 'plans assurance over',
    to: 'RISK-ENTERPRISE-RISK',
    cardinality: 'many-to-many',
    governance: 'Risk-based plan retains assessment basis.'
  },
  {
    id: 'RCA-R12',
    from: 'ASSURANCE-PLAN',
    predicate: 'may instantiate',
    to: 'AUDIT-ENGAGEMENT',
    cardinality: 'one-to-many',
    governance: 'Engagement is separate execution identity.'
  },
  {
    id: 'RCA-R13',
    ...
    to: 'AUDIT-FINDING',
    cardinality: 'one-to-many',
    governance: 'Findings remain separately tracked.'
  },
  {
    id: 'RCA-R14',
    from: 'AUDIT-FINDING',
    ...
    to: 'CTRL-INTERNAL-CONTROL',
    cardinality: 'many-to-many',
    governance: 'Finding and control remain distinct.'
  },
  {
    id: 'RCA-R15',
    from: 'AUDIT-FINDING',
    ...
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Requirement context is retained.'
  },
  {
    id: 'RCA-R16',
    from: 'AUDIT-FINDING',
    ...
    to: 'ASSURANCE-REMEDIATION-ACTION',
    cardinality: 'one-to-many',
    governance: 'Remediation action lifecycle is separate from finding closure.'
  },
  {
    id: 'RCA-R17',
    from: 'CTRL-CONTROL-TEST',
    ...
    to: 'ASSURANCE-REMEDIATION-ACTION',
    cardinality: 'one-to-many',
    governance: 'Control deficiency response remains explicit.'
  },
  {
    id: 'RCA-R18',
    from: 'COMP-ASSESSMENT',
    ...
    to: 'ASSURANCE-REMEDIATION-ACTION',
    cardinality: 'one-to-many',
    governance: 'Noncompliance remediation does not overwrite assessment evidence.'
  },
  {
    id: 'RCA-R19',
    from: 'INTEGRITY-CASE',
    ...
    to: 'ASSURANCE-REMEDIATION-ACTION',
    cardinality: 'one-to-many',
    governance: 'Case outcome/actions remain traceable and access-controlled.'
  },
  {
    id: 'RCA-R20',
    from: 'COMP-EVIDENCE',
    ...
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Evidence remains source-linked and attributable.'
  },
  {
    id: 'RCA-R21',
    from: 'ASSURANCE-REMEDIATION-ACTION',
    predicate: 'may be coordinated by',
    to: 'WORK-WORK-ITEM',
    cardinality: 'one-to-many',
    governance: 'Workflow work coordinates but does not replace remediation truth.'
  },
  {
    id: 'RCA-R22',
    from: 'AUDIT-ENGAGEMENT',
    ...
    cardinality: 'many-to-many',
    governance:
      'Material audit/closure decisions retain shared immutable decision evidence where required.'
  }
];
...
export function validateRiskComplianceAuditModel() {
  ...
  if (
    ids.size !== riskComplianceAuditModel.length ||
    relIds.size !== riskComplianceAuditRelationships.length
  )
    return false;
  ...
  if (
    riskComplianceAuditModel.some((x) => !x.definition || !x.identityRule || !x.governance.length)
  )
    return false;
  return riskComplianceAuditRelationships.every(
