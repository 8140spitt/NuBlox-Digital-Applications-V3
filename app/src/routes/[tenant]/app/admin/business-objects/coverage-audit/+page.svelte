    ...
    {:else}
      <div class="gap-grid">
        <article>
          ...
          <small>Duplicate/alias convergence and Gate 3 benchmark/standards challenge are closed. Next gates: aggregate-boundary freeze → L2/L3 object-action mapping.</small>
        </article>
      </div>
    {/if}
  </section>
