...
export const qhseAssuranceModel: QhseDefinition[] = [
  q(
    ...
    [
      'Quality Plan is not Project or Contract identity.',
      'Approved versions remain reconstructable.'
    ]
  ),
  q(
    'QHSE-ITP',
    ...
    ['Draft', 'Review', 'Approved', 'Current', 'Superseded', 'Closed'],
    [
      'ITP is planning/definition, not execution evidence.',
      'Revisions never rewrite completed inspection/test history.'
    ]
  ),
  q(
    'QHSE-INSPECTION',
    ['BOF-13-003', 'BOF-13-031'],
    'Inspection',
    'work',
    ...
    ['Planned', 'Ready', 'Performed', 'Verified', 'Closed', 'Invalidated'],
    [
      'Statutory inspection is a typed Inspection with jurisdiction/requirement context.',
      'Inspection evidence is not current Asset/Project state.'
    ]
  ),
  q(
    'QHSE-TEST',
    ...
    ['Planned', 'Ready', 'Performed', 'Verified', 'Accepted', 'Rejected', 'Invalidated'],
    [
      'Test and inspection may satisfy ITP points but remain distinct execution evidence.',
      'Measurement provenance is retained.'
    ]
  ),
  q(
    'QHSE-VERIFICATION-POINT',
    ['BOF-13-005', 'BOF-13-006'],
    'Verification Point',
    'controlled-definition',
    ...
    [
      ...
      'responsible/witness role',
      'release criteria'
    ],
    ['Draft', 'Effective', 'Satisfied', 'Waived', 'Superseded'],
    [
      'Hold and Witness Point are types on one model.',
      'Waiver/release requires attributable authority/evidence.'
    ]
  ),
  q(
    'QHSE-NCR',
    ...
    [
      'NCR is not automatically a Defect.',
      'Closure never deletes original evidence or disposition history.'
    ]
  ),
  q(
    'QHSE-DEFECT',
    ['BOF-13-008', 'BOF-13-009', 'BOF-17-016'],
    'Defect',
    'case',
    ...
    ['Open', 'Assigned', 'In Remediation', 'Ready for Verification', 'Closed', 'Rejected'],
    [
      'Snag is a Defect type.',
      'Commercial liability and operational work remain related but distinct.'
    ]
  ),
  q(
    'QHSE-CAPA-CASE',
    ...
    [
      'CAPA case does not replace source incident/NCR/audit finding.',
      'Effectiveness review is explicit.'
    ]
  ),
  q(
    'QHSE-CAPA-ACTION',
    ['BOF-13-010', 'BOF-13-011'],
    'CAPA Action',
    'work',
    ...
    ['action type', 'source/case', 'owner', 'due date', 'completion evidence', 'verified by/at'],
    ['Proposed', 'Accepted', 'In Progress', 'Completed', 'Verified', 'Cancelled'],
    [
      'Corrective and preventive are action types.',
      'Workflow Work Item may coordinate action but does not become domain truth.'
    ]
  ),
  q(
    'QHSE-AUDIT-ENGAGEMENT',
    ['BOF-13-013', 'BOF-21-012'],
    'Audit Engagement',
    'case',
    ...
    ['scope', 'criteria/standard', 'audit team', 'period', 'evidence', 'findings', 'report'],
    ['Planned', 'Fieldwork', 'Reporting', 'Response', 'Closed', 'Cancelled'],
    [
      'QHSE Audit reuses the enterprise audit pattern.',
      'Audit findings/actions remain separate governed records.'
    ]
  ),
  q(
    'QHSE-ASSURANCE-REVIEW',
    ['BOF-13-014'],
    'Assurance Review',
    'case',
    ...
    ['scope', 'review type', 'criteria', 'reviewers', 'evidence', 'conclusions/actions'],
  ...
  q(
    ...
    ['Recorded', 'Verified', 'Accepted', 'Rejected/Invalidated'],
    [
      'Calibration status is derived from retained records/effectivity.',
      'Failed calibration does not erase previous evidence.'
    ]
  ),
  q(
    'QHSE-QUALITY-CERTIFICATE',
    ['BOF-13-016'],
    'Quality Certificate',
    'event-evidence',
    ...
    ['Issued', 'Effective', 'Expired', 'Revoked', 'Superseded'],
  ...
  q(
    ...
    ['hazard type', 'description', 'source/context', 'potential consequences', 'applicability'],
    ['Identified', 'Active', 'Controlled', 'Retired'],
    [
      'Hazard is not Risk Assessment or Incident.',
      'One hazard may be assessed many times in different contexts.'
    ]
  ),
  q(
    'QHSE-RISK-ASSESSMENT',
    ['BOF-13-018', 'BOF-21-003'],
    'Risk Assessment',
    'event-evidence',
    ...
    [
      'Assessment is not the Hazard/Risk identity itself.',
      'QHSE and enterprise risk reuse one assessment pattern.'
    ]
  ),
  q(
    'QHSE-METHOD-STATEMENT',
    ['BOF-13-019', 'BOF-13-020'],
    'Method Statement / RAMS Controlled Information',
    'controlled-information',
    ...
    [
      'Method Statement and RAMS use Information Container semantics.',
      'RAMS references exact assessment/method basis and does not duplicate them.'
    ]
  ),
  q(
    'QHSE-PERMIT',
    ['BOF-13-021', 'BOF-12-017'],
    'Permit to Work',
    'case',
    ...
    [
      'Permit is an authorisation record, not generic workflow approval.',
      'Field operations and QHSE reuse one permit identity.'
    ]
  ),
  q(
    'QHSE-ISOLATION',
    ['BOF-13-022', 'BOF-12-018'],
    'Isolation',
    'case',
    ...
    [
      'Isolation is shared between site operations and QHSE.',
      'Isolation state must never be inferred only from a workflow task.'
    ]
  ),
  q(
    'QHSE-SAFETY-BRIEFING',
    ['BOF-13-023', 'BOF-13-024', 'BOF-13-025'],
    ...
    ['Planned', 'Delivered', 'Closed', 'Cancelled'],
    [
      'Induction/Briefing/Toolbox Talk are session types.',
      'Person attendance/outcome may create Learning Record evidence.'
    ]
  ),
  q(
    'QHSE-OBSERVATION',
    ['BOF-13-026'],
    'Safety / Quality Observation',
    'event-evidence',
  ...
  q(
    ...
    ['Reported', 'Triaged', 'Open', 'Investigating', 'Actions', 'Review', 'Closed'],
    [
      'Near Miss is an Incident type with no realised harmful consequence.',
      'Pollution Event is an environmental Incident type.',
      'Incident case does not overwrite source observations/evidence.'
    ]
  ),
  q(
    'QHSE-INVESTIGATION',
    ...
    ['Opened', 'Evidence Gathering', 'Analysis', 'Review', 'Completed', 'Reopened'],
    [
      'Investigation is separate from Incident lifecycle.',
      'Conclusions/cause findings are retained and attributable.'
    ]
  ),
  q(
    'QHSE-CAUSE',
    ...
    ['cause type', 'statement', 'analysis method', 'evidence references', 'confidence/validation'],
  ...
  q(
    ...
    [
      'QHSE and enterprise compliance reuse one requirement pattern.',
      'Requirement is distinct from evidence of compliance.'
    ]
  ),
  q(
    'QHSE-COMPLIANCE-REGISTER',
    ['BOF-13-033'],
    'Compliance Register',
    'projection',
    ...
    ['scope', 'requirements', 'owners', 'evidence', 'assessment/status', 'next review'],
    ['Current'],
    [
      'Compliance Register is not authoritative requirement/evidence truth.',
      'Changes in applicability/evidence recalculate the register.'
    ]
  ),
  q(
    'QHSE-ENV-ASPECT',
  ...
  q(
    ...
    [
      'impact type',
      'affected receptor/environment',
      'positive/negative',
      'scope',
      'significance basis'
    ],
    ['Identified', 'Active', 'Mitigated', 'Retired'],
  ...
  q(
    ...
    ['Prepared', 'Transferred', 'Received', 'Completed', 'Cancelled/Invalidated'],
    [
      'Waste Consignment is movement/evidence, not Waste Stream master.',
      'Regulatory documents remain controlled information/evidence.'
    ]
  )
];
...
export const qhseAssuranceRelationships: QhseRelationship[] = [
  {
    ...
    to: 'QHSE-QUALITY-PLAN',
    cardinality: 'many-to-one',
    governance: 'ITP remains a scoped verification plan under wider quality governance.'
  },
  {
    id: 'QHSE-R02',
    from: 'QHSE-ITP',
    predicate: 'defines',
    to: 'QHSE-VERIFICATION-POINT',
    cardinality: 'one-to-many',
    governance: 'Points are versioned with the ITP.'
  },
  {
    id: 'QHSE-R03',
    from: 'QHSE-INSPECTION',
    predicate: 'satisfies',
    to: 'QHSE-VERIFICATION-POINT',
    cardinality: 'many-to-zero-or-many',
    governance: 'Execution references exact point/version and evidence.'
  },
  {
    id: 'QHSE-R04',
    from: 'QHSE-TEST',
    ...
    to: 'QHSE-VERIFICATION-POINT',
    cardinality: 'many-to-zero-or-many',
    governance: 'Test result never overwrites point definition.'
  },
  {
    id: 'QHSE-R05',
    from: 'QHSE-NCR',
    ...
    governance: 'Nonconformance and physical/functional defect remain separable.'
  },
  {
    id: 'QHSE-R06',
    from: 'QHSE-CAPA-CASE',
    predicate: 'may originate from',
    to: 'QHSE-NCR',
    cardinality: 'many-to-zero-or-one',
    governance: 'CAPA preserves source provenance.'
  },
  {
    id: 'QHSE-R07',
    from: 'QHSE-CAPA-CASE',
    ...
    to: 'QHSE-CAPA-ACTION',
    cardinality: 'one-to-many',
    governance: 'Corrective/preventive action type is explicit.'
  },
  {
    id: 'QHSE-R08',
    from: 'QHSE-AUDIT-ENGAGEMENT',
    predicate: 'may create',
    to: 'QHSE-CAPA-CASE',
    cardinality: 'one-to-zero-or-many',
    governance: 'Audit and remediation lifecycles remain separate.'
  },
  {
    id: 'QHSE-R09',
    from: 'QHSE-ASSURANCE-REVIEW',
    predicate: 'may create',
    to: 'QHSE-CAPA-CASE',
    cardinality: 'one-to-zero-or-many',
    governance: 'Review findings retain source.'
  },
  {
    id: 'QHSE-R10',
    from: 'QHSE-INSPECTION',
    predicate: 'uses evidence of',
    to: 'QHSE-CALIBRATION',
    cardinality: 'many-to-zero-or-many',
    governance: 'Applicable equipment calibration is retained with execution.'
  },
  {
    id: 'QHSE-R11',
    from: 'QHSE-RISK-ASSESSMENT',
    predicate: 'assesses',
    to: 'QHSE-HAZARD',
    cardinality: 'many-to-many',
    governance: 'Hazard identity survives assessment revisions.'
  },
  {
    id: 'QHSE-R12',
    from: 'QHSE-PERMIT',
    predicate: 'requires/uses',
    to: 'QHSE-RISK-ASSESSMENT',
    cardinality: 'many-to-many',
    governance: 'Permit binds exact effective assessment basis.'
  },
  {
    id: 'QHSE-R13',
    from: 'QHSE-PERMIT',
    predicate: 'controls with',
    to: 'QHSE-ISOLATION',
    cardinality: 'many-to-many',
    governance: 'Isolation state/evidence remains independently governed.'
  },
  {
    id: 'QHSE-R14',
    from: 'QHSE-SAFETY-BRIEFING',
    predicate: 'communicates controls from',
    to: 'QHSE-RISK-ASSESSMENT',
    cardinality: 'many-to-many',
    governance: 'Session references exact assessment/information basis.'
  },
  {
    id: 'QHSE-R15',
    from: 'QHSE-OBSERVATION',
    predicate: 'may initiate',
    to: 'QHSE-INCIDENT',
    cardinality: 'many-to-zero-or-one',
    governance: 'Observation remains immutable source evidence.'
  },
  {
    id: 'QHSE-R16',
    from: 'QHSE-INCIDENT',
    predicate: 'may be investigated by',
    to: 'QHSE-INVESTIGATION',
    cardinality: 'one-to-zero-or-many',
    governance: 'Incident and investigation have independent states.'
  },
  {
    id: 'QHSE-R17',
    from: 'QHSE-INVESTIGATION',
    predicate: 'produces',
    to: 'QHSE-CAUSE',
    cardinality: 'one-to-zero-or-many',
    governance: 'Cause findings retain analysis provenance.'
  },
  {
    id: 'QHSE-R18',
    from: 'QHSE-INVESTIGATION',
    ...
    to: 'QHSE-CAPA-CASE',
    cardinality: 'one-to-zero-or-many',
    governance: 'Actions do not overwrite incident/investigation truth.'
  },
  {
    id: 'QHSE-R19',
    from: 'QHSE-COMPLIANCE-REGISTER',
    predicate: 'projects applicability of',
    to: 'QHSE-COMPLIANCE-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Register is rebuildable from requirements/evidence.'
  },
  {
    id: 'QHSE-R20',
    from: 'QHSE-ENV-ASPECT',
    predicate: 'may cause',
    to: 'QHSE-ENV-IMPACT',
    cardinality: 'many-to-many',
    governance: 'Aspect and impact remain distinct concepts.'
  },
  {
    id: 'QHSE-R21',
    from: 'QHSE-INCIDENT',
    predicate: 'may concern',
    to: 'QHSE-ENV-ASPECT',
    cardinality: 'many-to-many',
    governance: 'Environmental incident classification references applicable aspects/impacts.'
  },
  {
    id: 'QHSE-R22',
    from: 'QHSE-WASTE-CONSIGNMENT',
    predicate: 'may evidence compliance with',
    to: 'QHSE-COMPLIANCE-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Waste movement evidence remains immutable.'
  },
  {
    id: 'QHSE-R23',
    from: 'QHSE-QUALITY-CERTIFICATE',
    predicate: 'may evidence result of',
    to: 'QHSE-INSPECTION',
    cardinality: 'many-to-zero-or-many',
    governance: 'Certificate is evidence, not inspection identity.'
  },
  {
    id: 'QHSE-R24',
    from: 'QHSE-QUALITY-CERTIFICATE',
    ...
    to: 'QHSE-TEST',
    cardinality: 'many-to-zero-or-many',
    governance: 'Certificate preserves exact verification basis.'
  }
];
...
export function validateQhseAssuranceModel() {
  ...
  if (
    qhseAssuranceModel.some(
      (x) => !x.canonicalName || !x.definition || !x.identityRule || !x.governance.length
    )
  )
    return false;
