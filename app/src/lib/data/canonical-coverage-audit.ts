...
export const coverageAuditSummary = {
  ...
  externalBenchmark: {
    ...
    challengedBenchmarks: marketBenchmarkSummary.challengedBenchmarkCount,
    inProgressBenchmarks: marketBenchmarkSummary.inProgressBenchmarkCount,
    registeredBenchmarksPending: marketBenchmarkSummary.registeredBenchmarkCount,
