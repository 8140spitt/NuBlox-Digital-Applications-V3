...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>One reusable Item identity connects product, material and service definitions to catalogues, pricing, BOMs, manufacturing definitions, traceability and as-manufactured evidence without duplicating masters across ERP workspaces.</p>
    </div>
    <div class="hero-actions">
      <a href={`/${data.tenantSlug}/app/admin/business-objects`}>← Canonicalization workbench</a>
      <a href={`/${data.tenantSlug}/app/admin/business-objects/commercial-procurement`}>Commercial & procurement</a>
  ...
  <section class="section-card flow">
    ...
    <div class="flow-row">
      <article><small>Definition</small><strong>Item</strong><span>Product / Material / Service classification</span></article>
      <b>→</b>
      <article><small>Technical</small><strong>Specification / Variant / BOM</strong><span>Controlled definition and product structure</span></article>
      <b>→</b>
      <article><small>Manufacturing</small><strong>Definition / Process Plan</strong><span>How the Item is produced</span></article>
      <b>→</b>
      <article><small>Execution</small><strong>Production Order</strong><span>Authorised production work</span></article>
      <b>→</b>
      <article><small>Traceability</small><strong>Lot / Batch / Serial</strong><span>Actual provenance</span></article>
      <b>→</b>
      <article><small>Actual</small><strong>As-Manufactured</strong><span>Evidence of what was produced</span></article>
    </div>
  </section>
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div><span class="eyebrow">Semantic contracts</span><h2>Governed item & manufacturing constructs</h2></div>
      <p>Open a construct to inspect its identity contract, scope, lifecycle and modelling boundaries.</p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div><span class="eyebrow">Relationship graph</span><h2>How definition, commercial context, manufacturing and traceability connect</h2></div>
      <p>Relationships carry effectivity and provenance without duplicating canonical identities.</p>
    </div>
        ...
        <tbody>
          {#each itemManufacturingRelationships as relationship}
            <tr>
              ...
              <td><strong>{names.get(relationship.from)}</strong><small>{relationship.from}</small></td>
