...
export const inventoryLogisticsModel: InventoryLogisticsDefinition[] = [
  {
    ...
    definition:
      'A governed inventory-storage and logistics context associated with a canonical Site or Facility and responsible organisation.',
    identityRule:
      'Stable Warehouse identity; site/location changes are governed relationships and do not create a new Item or stock identity.',
  ...
  },
  {
    ...
    identityRule:
      'Stable Store identity within its inventory context; relocation does not redefine Item or traceability identity.',
  ...
  },
  {
    ...
    kind: 'storage-context',
    definition:
      'The lowest governed inventory storage location used to identify where stock is physically or logically held.',
    identityRule:
      'Stable Bin Location identity under a Store/Warehouse; codes are business identifiers and can be changed with retained history.',
  ...
  },
  {
    ...
    kind: 'relationship',
    definition:
      'An effective commitment of available inventory quantity to a demand context without changing ownership or physical location.',
    identityRule:
      'Stable reservation relationship identity referencing demand, Item and optional lot/batch/serial/location constraints.',
  ...
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'An immutable inventory event recording quantity movement, issue, return or transfer between governed custody/location contexts.',
    identityRule:
      'Each posted movement has immutable event identity; corrections use reversing/correcting events rather than destructive edits.',
  ...
  },
  {
    ...
    kind: 'projection',
    definition:
      'A derived as-of view of on-hand, available, reserved, quarantined and in-transit quantity for an Item/traceability/location combination.',
  ...
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'A controlled physical/cycle count observation of inventory at a defined location and count scope.',
    identityRule:
      'Immutable count observation identity; approval may generate an Inventory Adjustment but never rewrites prior movement history.',
  ...
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'A governed posted correction to inventory quantity/status with explicit reason, authority and evidence.',
    identityRule:
      'Immutable posted adjustment identity; corrections require another governed adjustment/reversal.',
  ...
  },
  {
    ...
    kind: 'case',
    definition:
      'A governed restriction case preventing or limiting use of identified inventory pending disposition, quality, safety or compliance resolution.',
    identityRule:
      'Stable quarantine case identity referencing affected inventory identities/quantities and evidence.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A governed logistics work record selecting inventory from storage to fulfil shipment, issue, production or project demand.',
    identityRule:
      'Stable Pick identity referencing exact inventory and demand; completion records actual quantities/traceability selected.',
    scope: ['warehouse/store', 'demand/order/shipment'],
    keyData: [
      'demand',
      'Item',
      'requested/actual quantity',
      'source bin',
      'lot/batch/serial',
      'picker',
      'timestamps'
    ...
    governance: [
      'Pick is execution work and does not change Item identity; completed pick evidence feeds subsequent inventory movement/shipment.'
    ]
  },
  {
    modelId: 'LOG-PACK',
    ...
    kind: 'work',
    definition:
      'A governed logistics record grouping picked goods into handling units/packages for transport and delivery.',
    identityRule:
      'Stable Pack/handling record identity; package contents are explicit and traceable.',
    ...
    governance: [
      'Pack is logistics execution, not Commercial Package, Procurement Package or Work Package.'
    ]
  },
  {
    ...
    kind: 'transaction',
    definition:
      'A governed consignment of goods moving from an origin to a destination under a defined logistics movement.',
    identityRule:
      'Stable Shipment identity; contents, handling units, origin/destination and transport references remain traceable.',
  ...
  },
  {
    ...
    kind: 'transaction',
    definition:
      'A governed request/commitment for transport capacity or service to move one or more Shipments.',
    identityRule:
      'Stable Transport Order identity independent of the Shipment identities it carries.',
    ...
    governance: [
      'Carrier is a canonical Party/Organisation role; the transport order does not duplicate supplier identity.'
    ]
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'An immutable evidence record that specified Shipment contents reached a destination and were received, rejected or partially accepted.',
    identityRule:
      'Stable delivery event/evidence identity tied to the Shipment and receiving context.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A governed booking allocating a delivery/collection time-window and site logistics resource/access context.',
    identityRule:
      'Stable booking identity referencing Site, Shipment/Transport Order and logistics resource constraints.',
    ...
    governance: [
      'Site Logistics Booking is not an Asset or Site master; it consumes canonical Site and logistics identities.'
    ]
  },
  {
    ...
    definition:
      'A governed import/export/trade declaration submitted or retained for cross-border movement and customs/compliance purposes.',
    identityRule:
      'Stable declaration identity; import and export are declaration types rather than separate data silos.',
...
export const inventoryLogisticsRelationships: InventoryLogisticsRelationship[] = [
  {
    ...
    cardinality: '1 ↔ 0..*',
    governance:
      'Store remains an independent storage context under one current warehouse/site context.'
  },
  {
    id: 'INV-R02',
    from: 'INV-STORE',
    ...
    to: 'INV-BIN',
    cardinality: '1 ↔ 0..*',
    governance: 'Bin hierarchy is acyclic and storage-specific.'
  },
  {
    id: 'INV-R03',
    from: 'INV-WAREHOUSE',
    ...
    to: 'CBO-SITE',
    cardinality: '0..* ↔ 1',
    governance: 'Warehouse references canonical Site identity.'
  },
  {
    id: 'INV-R04',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 1',
    governance: 'Reservation constrains quantity, not Item identity.'
  },
  {
    id: 'INV-R05',
    from: 'INV-MOVEMENT',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 1',
    governance: 'Posted movement references exact Item and traceability where required.'
  },
  {
    id: 'INV-R06',
    from: 'INV-MOVEMENT',
    ...
    cardinality: '0..* ↔ 0..2',
    governance:
      'Movement records source and destination separately; external origins/destinations may use other contexts.'
  },
  {
    id: 'INV-R07',
    from: 'INV-STOCK-COUNT',
    predicate: 'observes',
    to: 'INV-BIN',
    cardinality: '0..* ↔ 1',
    governance: 'Count snapshot preserves its location and as-of basis.'
  },
  {
    id: 'INV-R08',
    from: 'INV-ADJUSTMENT',
    predicate: 'corrects position for',
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 1',
    governance: 'Adjustment requires reason/authority and produces traceable inventory effect.'
  },
  {
    id: 'INV-R09',
    from: 'INV-QUARANTINE',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 1',
    governance: 'Affected lot/batch/serial/location are additional scope, not new Item identities.'
  },
  {
    id: 'INV-R10',
    from: 'LOG-PICK',
    ...
    to: 'INV-RESERVATION',
    cardinality: '0..* ↔ 0..*',
    governance: 'Pick may fulfil reservation/demand partially.'
  },
  {
    id: 'INV-R11',
    from: 'LOG-PACK',
    ...
    to: 'LOG-SHIPMENT',
    cardinality: '0..* ↔ 1',
    governance: 'Handling/package identity remains logistics-specific.'
  },
  {
    id: 'INV-R12',
    from: 'LOG-SHIPMENT',
    predicate: 'transported under',
    to: 'LOG-TRANSPORT-ORDER',
    cardinality: '0..* ↔ 0..1',
    governance: 'One transport order may carry multiple shipments.'
  },
  {
    id: 'INV-R13',
    from: 'LOG-DELIVERY',
    ...
    to: 'LOG-SHIPMENT',
    cardinality: '0..* ↔ 1',
    governance: 'Partial/multiple deliveries can occur for one shipment.'
  },
  {
    id: 'INV-R14',
    from: 'LOG-SITE-BOOKING',
    predicate: 'coordinates',
    to: 'LOG-SHIPMENT',
    cardinality: '0..* ↔ 0..1',
    governance: 'Booking references shipment/transport without redefining either.'
  },
  {
    id: 'INV-R15',
    from: 'LOG-SITE-BOOKING',
    ...
    to: 'CBO-SITE',
    cardinality: '0..* ↔ 1',
    governance: 'Site identity is consumed from built-environment model.'
  },
  {
    id: 'INV-R16',
    from: 'LOG-TRADE-DECLARATION',
    predicate: 'declares',
    to: 'LOG-SHIPMENT',
    cardinality: '0..* ↔ 1..*',
    governance: 'Declaration captures jurisdictional/compliance evidence for shipment movement.'
  }
];
...
export const inventoryLogisticsBoundaries: InventoryLogisticsBoundary[] = [
  {
    name: 'Definition',
    structure: 'Item → specification / lot / batch / serial references',
    purpose: 'What is being held or moved',
    mustNotBecome: 'Stock quantity or warehouse hierarchy'
  },
  {
    name: 'Storage',
    structure: 'Warehouse → Store → Bin Location',
    purpose: 'Where inventory is held',
    mustNotBecome: 'Site hierarchy, WBS or Asset hierarchy'
  },
  {
    name: 'Inventory truth',
    structure: 'Movement + Reservation + Quarantine → Stock Position',
    purpose: 'Quantity and availability as-of time',
    mustNotBecome: 'Editable stock-on-hand master'
  },
  {
    name: 'Logistics',
    structure: 'Pick → Pack → Shipment → Transport → Delivery',
    purpose: 'Physical fulfilment and movement',
    mustNotBecome: 'Procurement, contract or project structure'
  }
];
