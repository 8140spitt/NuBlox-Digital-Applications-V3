...
export const continuityCrisisSecurityModel: ContinuityCrisisSecurityDefinition[] = [
  ccs(
    'BCM-BUSINESS-IMPACT-ASSESSMENT',
    ['BOF-23-001'],
    ...
    [
      'BIA is assessment evidence, not Continuity Plan.',
      'Reassessment creates successor evidence rather than overwriting prior impact analysis.',
      'Criticality and recovery requirements must remain traceable to exact assessment scope/version.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'Recovery Requirement is not the Continuity Plan or Disaster Recovery Plan.',
      'Thresholds retain source BIA/version provenance.',
      'Technology recovery objectives may be consumed by BOF-24 DR planning.'
    ]
  ),

  ccs(
    'BCM-CONTINUITY-STRATEGY',
    ['BOF-23-002'],
    'Continuity Strategy',
    'strategy',
    ...
    [
      'Continuity Strategy is not an executable Continuity Plan.',
      'Strategy choices retain BIA/Risk/Decision provenance.',
      'Technology-specific DR strategies/plans remain within BOF-24 execution context.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'Plan content may be represented through Information Container but the structured plan semantics remain queryable.',
      'Invoking a plan creates occurrence evidence rather than mutating the plan into a Crisis.',
      'Approved plan versions are immutable.'
    ]
  ),

  ccs(
    'BCM-CONTINUITY-EXERCISE',
    ['BOF-23-004'],
    'Continuity Exercise',
    'event-evidence',
    ...
    [
      'Exercise is evidence, not Plan state.',
      'Improvement actions remain separately governed shared actions.',
      'A failed exercise never rewrites the tested plan/result history.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'crisis reference/type',
      'declared at/by',
      'trigger/events',
      'affected services/sites/assets/people',
      'command/roles',
      'severity',
      'objectives',
      'status',
    ...
    [
      'Crisis is not the Emergency Event itself.',
      'Crisis team composition reuses Role/Responsibility Assignments rather than creating duplicate people/teams.',
      'Decisions/actions/communications remain separate governed records.'
    ]
  ),
  ...
  ccs(
    ...
    [
      ...
      'location/scope',
      'affected people/services/assets',
      'initial severity',
      'source/reporting Party',
      'evidence',
      'correction links'
    ],
    ['Recorded', 'Corrected/Superseded'],
    [
      'Emergency Event is occurrence evidence, not Crisis case.',
      'Specialist QHSE, security, privacy or IT cases may reference the same event without duplicating occurrence facts.',
  ...
  ccs(
    ...
    [
      ...
      'Work Item may coordinate but does not replace the action.',
      'Action completion does not alter immutable source event/decision evidence.'
    ]
  ),

  ccs(
    'BCM-CRISIS-COMMUNICATION',
    ['BOF-23-008'],
    ...
    [
      'Crisis Communication reuses Communication Item.',
      'Message content remains Information Container content.',
      'Emergency communication may use exceptional approval paths but authority/evidence must still be retained.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'Invocation is not Disaster Recovery Plan.',
      'BOF-24 owns technology DR Plan semantics.',
      'Recovery evidence retains actual timings against requirements without rewriting the plan.'
    ]
  ),

  ccs(
    'SEC-PHYSICAL-SECURITY-ZONE',
    ['BOF-23-010'],
    ...
    [
      'zone code/name',
      'security level',
      'covered spatial extents',
      'access rules',
      'escort/visitor rules',
      'owner',
      'effective dates',
      'status'
    ],
    ...
    [
      'Security Zone is a control overlay, not geometric/spatial identity.',
      'Spatial extents reference canonical Site/Building/Level/Space/Zone.',
      'Access rules/effectivity are historically reconstructable.'
    ]
  ),

  ccs(
    'SEC-PHYSICAL-ACCESS-CREDENTIAL',
    ['BOF-23-011', 'BOF-23-012'],
    ...
    [
      'Credential is authorization, not Person identity.',
      'Visitor Pass is a typed credential with visitor/sponsor context.',
      'Possessing a credential does not itself prove an access occurrence.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'Access Event is not credential state.',
      'Corrections are append-only.',
      'Monitoring/analytics are projections over retained access events.'
    ]
  ),
  ...
  ccs(
    ...
    [
      'Physical Security Incident is distinct from Cyber Security Incident, Privacy Incident and QHSE Incident while cross-links may share underlying event facts.',
      'Restricted access/need-to-know may apply.',
      'Investigation findings/actions remain attributable.'
    ]
  ),

  ccs(
    'SEC-TRAVEL-RISK-ASSESSMENT',
    ['BOF-23-014'],
    ...
    [
      'Travel Risk Assessment reuses shared Risk Assessment.',
      'Travel itinerary/journey data remains in its authoritative source.',
      'Reassessment creates new evidence.'
    ]
  ),
  ...
  ccs(
    ...
    ['Draft', 'Reviewed', 'Approved', 'Effective', 'Superseded', 'Expired'],
    [
      'Security Risk Assessment reuses shared Risk Assessment.',
      'Enterprise Risk may represent material enduring exposure while assessments remain evidence.',
      'Controls/zone configuration remain separately governed.'
    ]
  )
];
...
export const continuityCrisisSecurityRelationships: ContinuityCrisisSecurityRelationship[] = [
  {
    id: 'CCS-R01',
    from: 'BCM-BUSINESS-IMPACT-ASSESSMENT',
    predicate: 'produces',
    to: 'BCM-RECOVERY-REQUIREMENT',
    cardinality: 'one-to-many',
    governance: 'Recovery objectives retain exact BIA basis/version.'
  },
  {
    id: 'CCS-R02',
    from: 'BCM-CONTINUITY-STRATEGY',
    predicate: 'satisfies',
    to: 'BCM-RECOVERY-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Strategy choice explicitly maps to required recovery objectives.'
  },
  {
    id: 'CCS-R03',
    from: 'BCM-CONTINUITY-PLAN',
    predicate: 'implements',
    to: 'BCM-CONTINUITY-STRATEGY',
    cardinality: 'many-to-one-or-many',
    governance: 'Plan execution remains distinct from strategic approach.'
  },
  {
    id: 'CCS-R04',
    from: 'BCM-CONTINUITY-PLAN',
    ...
    to: 'BCM-RECOVERY-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Plan version retains exact requirements/effectivity.'
  },
  {
    id: 'CCS-R05',
    from: 'BCM-CONTINUITY-EXERCISE',
    predicate: 'tests',
    to: 'BCM-CONTINUITY-PLAN',
    cardinality: 'many-to-one-or-many',
    governance: 'Exercise pins exact plan/version.'
  },
  {
    id: 'CCS-R06',
    from: 'BCM-CONTINUITY-EXERCISE',
    ...
    cardinality: 'one-to-many',
    governance: 'Improvement action remains shared action truth.'
  },
  {
    id: 'CCS-R07',
    from: 'BCM-CRISIS',
    predicate: 'may be triggered by',
    to: 'BCM-EMERGENCY-EVENT',
    cardinality: 'one-to-many',
    governance: 'Crisis and occurrence evidence remain distinct.'
  },
  {
    id: 'CCS-R08',
    from: 'BCM-CRISIS',
    ...
    to: 'WORK-DECISION',
    cardinality: 'one-to-many',
    governance: 'Material command/response decisions use shared immutable Decision evidence.'
  },
  {
    id: 'CCS-R09',
    from: 'BCM-CRISIS-ACTION',
    predicate: 'reuses',
    to: 'WORK-FOLLOW-UP-ACTION',
    cardinality: 'many-to-one-pattern',
    governance: 'Crisis actions use shared action architecture.'
  },
  {
    id: 'CCS-R10',
    from: 'BCM-CRISIS-COMMUNICATION',
    predicate: 'reuses',
    to: 'KRC-COMMUNICATION-ITEM',
    cardinality: 'many-to-one-pattern',
    governance: 'Communication execution and content remain shared.'
  },
  {
    id: 'CCS-R11',
    ...
    governance: 'Invocation pins exact future BOF-24 DR Plan/version.'
  },
  {
    id: 'CCS-R12',
    from: 'BCM-DR-INVOCATION',
    ...
    governance: 'Technology recovery and enterprise crisis case remain separable.'
  },
  {
    id: 'CCS-R13',
    from: 'SEC-PHYSICAL-SECURITY-ZONE',
    predicate: 'covers',
    to: 'CBO-SITE',
    cardinality: 'many-to-many',
    governance: 'Security overlay references canonical Site.'
  },
  {
    id: 'CCS-R14',
    from: 'SEC-PHYSICAL-SECURITY-ZONE',
    ...
    to: 'BE-SPACE',
    cardinality: 'many-to-many',
    governance: 'Space identity remains canonical.'
  },
  {
    id: 'CCS-R15',
    from: 'SEC-PHYSICAL-ACCESS-CREDENTIAL',
    predicate: 'authorises access to',
    to: 'SEC-PHYSICAL-SECURITY-ZONE',
    cardinality: 'many-to-many',
    governance: 'Zone entitlement is explicit and effective-dated.'
  },
  {
    id: 'CCS-R16',
    from: 'SEC-PHYSICAL-ACCESS-CREDENTIAL',
    ...
    to: 'CBO-PARTY',
    cardinality: 'many-to-one',
    governance: 'Credential never becomes Person/Party identity.'
  },
  {
    id: 'CCS-R17',
    from: 'SEC-PHYSICAL-ACCESS-EVENT',
    predicate: 'uses',
    to: 'SEC-PHYSICAL-ACCESS-CREDENTIAL',
    cardinality: 'many-to-one',
    governance: 'Occurrence retains exact credential/subject context.'
  },
  {
    id: 'CCS-R18',
    from: 'SEC-PHYSICAL-ACCESS-EVENT',
    ...
    to: 'SEC-PHYSICAL-SECURITY-ZONE',
    cardinality: 'many-to-one-or-many',
    governance: 'Access event and security-zone configuration remain separate.'
  },
  {
    id: 'CCS-R19',
    from: 'SEC-PHYSICAL-SECURITY-INCIDENT',
    predicate: 'may reference',
    to: 'SEC-PHYSICAL-ACCESS-EVENT',
    cardinality: 'one-to-many',
    governance: 'Incident case preserves source occurrence evidence.'
  },
  {
    id: 'CCS-R20',
    from: 'SEC-PHYSICAL-SECURITY-INCIDENT',
    ...
    to: 'CBO-ASSET',
    cardinality: 'many-to-many',
    governance: 'Asset identity remains whole-life canonical object.'
  },
  {
    id: 'CCS-R21',
    from: 'SEC-PHYSICAL-SECURITY-INCIDENT',
    ...
    to: 'WORK-FOLLOW-UP-ACTION',
    cardinality: 'one-to-many',
    governance: 'Response/remediation actions remain separately governed.'
  },
  {
    id: 'CCS-R22',
    from: 'SEC-TRAVEL-RISK-ASSESSMENT',
    predicate: 'reuses',
    to: 'RISK-ASSESSMENT',
    cardinality: 'many-to-one-pattern',
    governance: 'Travel assessment uses shared enterprise risk-assessment evidence.'
  },
  {
    id: 'CCS-R23',
    from: 'SEC-SECURITY-RISK-ASSESSMENT',
    predicate: 'reuses',
    to: 'RISK-ASSESSMENT',
    cardinality: 'many-to-one-pattern',
    governance: 'Security assessment uses shared enterprise risk-assessment evidence.'
  },
  {
    id: 'CCS-R24',
    from: 'SEC-SECURITY-RISK-ASSESSMENT',
    predicate: 'may assess',
    to: 'SEC-PHYSICAL-SECURITY-ZONE',
    cardinality: 'many-to-many',
    governance: 'Zone configuration does not become risk evidence.'
  },
  {
    id: 'CCS-R25',
    from: 'BCM-BUSINESS-IMPACT-ASSESSMENT',
    ...
    to: 'CBO-ASSET',
    cardinality: 'many-to-many',
    governance: 'Critical asset dependencies reference canonical Assets.'
  },
  {
    id: 'CCS-R26',
    from: 'BCM-CRISIS',
    ...
    to: 'CBO-SITE',
    cardinality: 'many-to-many',
    governance: 'Crisis scope references canonical physical context.'
  }
];
...
export function validateContinuityCrisisSecurityModel() {
  ...
  if (
    ids.size !== continuityCrisisSecurityModel.length ||
    relIds.size !== continuityCrisisSecurityRelationships.length
  )
    return false;
  const candidates = new Set(continuityCrisisSecurityModel.flatMap((x) => x.candidateKeys));
  for (let i = 1; i <= 15; i += 1)
    if (!candidates.has(`BOF-23-${String(i).padStart(3, '0')}`)) return false;
  if (
    continuityCrisisSecurityModel.some(
      (x) => !x.definition || !x.identityRule || !x.governance.length
    )
  )
    return false;
  return continuityCrisisSecurityRelationships.every(
