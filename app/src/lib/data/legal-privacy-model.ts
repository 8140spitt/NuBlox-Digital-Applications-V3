...
export const legalPrivacyModel: LegalPrivacyDefinition[] = [
  lp(
    ...
    [
      ...
      'owner/counsel',
      'jurisdiction',
      'related Contracts/Projects',
      'privilege/confidentiality',
      'status'
    ],
    ['Opened', 'Assessment', 'Active', 'On Hold', 'Resolved', 'Closed', 'Reopened'],
    [
      'Legal Matter never duplicates Party, Contract, Project or regulator-case identity.',
      'Regulatory Matter is a Legal Matter type unless a specialist domain owns a more specific regulator case.',
      'Privilege/confidentiality and access are explicitly governed.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Advice Request is not the advice document or Legal Matter itself.',
      'Material changes to facts/question create a new governed cycle/version.',
      'Legal privilege status is retained separately from generic access.'
    ]
  ),
  ...
  lp(
    ...
    [
      'source authority/order/statute',
      'obligor/subject',
    ...
    [
      'Contract duties remain Contract Obligations and regulatory duties remain Regulatory Obligations.',
      'Legal Obligation can drive Compliance Requirements without becoming compliance evidence.',
      'Satisfaction/breach remains evidenced and historically reconstructable.'
    ]
  ),

  lp(
    'LEGAL-STATUTORY-FILING',
    ['BOF-22-004'],
    'Statutory Filing',
    'filing',
    ...
    [
      'Filing is not the submitted file; files are controlled information representations.',
      'External submission evidence pins exact content/version and time.',
      'Recurring filings create distinct period/event identities.'
    ]
  ),
  ...
  lp(
    ...
    [
      'IP type/title',
      'owner Party',
      'creator/inventor where relevant',
      'jurisdiction',
    ...
    [
      'IP Asset is not a finance Fixed Asset although finance may reference it.',
      'Registry documents/evidence remain controlled information/evidence.',
      'Ownership/licence changes preserve history.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Dispute is not Contract or Claim identity.',
      'A formal Legal Proceeding can arise from a Dispute without replacing it.',
      'Settlement and decisions remain attributable evidence.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Legal Proceeding is distinct from Dispute and Legal Matter.',
      'Court orders/judgments may create Legal Obligations explicitly.',
      'Proceeding evidence is preserved under legal-hold/retention rules.'
    ]
  ),
  ...
  lp(
    ...
    [
      ...
      'issued by/authority',
      'custodians',
      'systems/data/record scope',
      'effective date',
      'instructions',
      'release criteria/date'
    ],
    ['Draft', 'Issued', 'Active', 'Amended', 'Released', 'Closed'],
    [
      'Legal Hold is the preservation instruction; Legal Hold Link is the object relationship.',
      'Hold does not change source-object identity or content.',
      'Release never deletes evidence of the hold period.'
    ]
  ),

  lp(
    'LEGAL-EDISCOVERY-COLLECTION',
    ['BOF-22-010'],
    ...
    [
      'Collection is not the live source dataset.',
      'Source provenance and integrity metadata are mandatory.',
      'Recollection creates a new traceable collection occurrence.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Information Container reference',
      'policy/notice type',
      'audience',
      'jurisdiction',
      'effective revision',
    ...
    [
      'Privacy Policy reuses Information Container.',
      'Published revision history and exact wording remain reconstructable.',
      'Consent evidence references the exact applicable wording/version where relevant.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Framework is governance/configuration, not a Processing Activity or policy document.',
      'Historic assessments retain exact framework/version.',
      'Jurisdictional overlays are explicit.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Processing Activity is the governed RoPA-style processing definition, not execution telemetry.',
      'Systems/Datasets/Parties are referenced canonically.',
      'Material changes preserve change/review history and may trigger DPIA reassessment.'
    ]
  ),
  ...
  lp(
    ...
    [
      'processing/activity/change scope',
      'trigger/threshold',
      'data flows',
      'risks',
      'controls',
      ...
      'consultation',
      'decision',
      'assessed/approved at'
    ],
    ['Draft', 'Consultation', 'Review', 'Approved', 'Actions Required', 'Superseded', 'Expired'],
    [
      'DPIA is assessment evidence, not Processing Activity identity.',
      'Reassessment creates successor evidence rather than overwriting the previous assessment.',
      'Risks can link to shared Enterprise Risk/Risk Assessment where enterprise treatment is required.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Consent is evidence and lawful-basis context, not Person identity.',
      'Withdrawal never erases earlier consent evidence.',
      'Current consent position is derived from retained valid events.'
    ]
  ),

  lp(
    'PRIV-PREFERENCE-EVIDENCE',
    ['BOF-22-016'],
    'Preference Evidence',
    'event-evidence',
    ...
    [
      'Preference is distinct from Consent unless a legal rule explicitly maps it.',
      'Current preference is derived from retained events.',
      'Notification Preference configuration may consume this evidence but is not the same object.'
    ]
  ),
  ...
  lp(
    ...
    [
      'Request is not a generic Work Item.',
      'Identity verification and legal exceptions are evidenced.',
      'Response/disclosure references exact controlled information/evidence released.'
    ]
  ),

  lp(
    'PRIV-INCIDENT',
    ['BOF-22-018', 'BOF-22-019'],
    'Privacy Incident',
    'case',
    ...
    [
      'incident type',
      'occurred/detected at',
      'Processing Activities/systems',
      'data/categories',
      'affected subjects',
      'impact',
    ...
    [
      'Privacy Breach is a Privacy Incident type/classification.',
      'Breach determination and notification decision are retained evidence.',
      'Cyber/IT incidents may be linked without creating duplicate underlying event facts.'
    ]
  ),

  lp(
    'PRIV-INTERNATIONAL-TRANSFER',
    ['BOF-22-020'],
    'International Data Transfer Arrangement',
    'relationship',
    ...
    [
      'Arrangement is not one runtime data-transfer event.',
      'Parties, systems and datasets retain canonical identity.',
      'Mechanism and transfer-risk assessment/version are historically pinned.'
    ]
  ),

  lp(
    'PRIV-ASSURANCE-REVIEW',
    ['BOF-22-021'],
    ...
    [
      'shared Assurance Review reference',
      'privacy scope',
      'criteria/framework',
      'evidence',
      'reviewer',
    ...
    [
      'Privacy Assurance Review reuses shared Assurance Review.',
      'Formal audit work continues to use Audit Engagement.',
      'Review findings/remediation remain separately governed.'
    ]
  )
];
...
export const legalPrivacyRelationships: LegalPrivacyRelationship[] = [
  {
    id: 'LP-R01',
    from: 'LEGAL-ADVICE-REQUEST',
    predicate: 'may belong to',
    to: 'LEGAL-MATTER',
    cardinality: 'many-to-zero-or-one',
    governance: 'Advice remains separately traceable from matter lifecycle.'
  },
  {
    id: 'LP-R02',
    from: 'LEGAL-DISPUTE',
    ...
    to: 'LEGAL-MATTER',
    cardinality: 'many-to-zero-or-one',
    governance: 'Dispute context does not replace overarching legal matter.'
  },
  {
    id: 'LP-R03',
    from: 'LEGAL-PROCEEDING',
    predicate: 'may arise from',
    to: 'LEGAL-DISPUTE',
    cardinality: 'many-to-zero-or-one',
    governance: 'Proceeding and dispute retain separate identities.'
  },
  {
    id: 'LP-R04',
    from: 'LEGAL-PROCEEDING',
    ...
    governance: 'Orders/judgments produce explicit obligations with source provenance.'
  },
  {
    id: 'LP-R05',
    from: 'LEGAL-STATUTORY-FILING',
    predicate: 'may satisfy',
    to: 'LEGAL-OBLIGATION',
    cardinality: 'many-to-many',
    governance: 'Filing and obligation remain distinct.'
  },
  {
    id: 'LP-R06',
    from: 'LEGAL-STATUTORY-FILING',
    ...
    cardinality: 'one-to-many',
    governance: 'Actual filing submissions pin exact content/version and external evidence.'
  },
  {
    id: 'LP-R07',
    from: 'LEGAL-HOLD',
    predicate: 'applies through',
    to: 'EVID-LEGAL-HOLD-LINK',
    cardinality: 'one-to-many',
    governance: 'Hold links place exact objects/evidence in preservation scope.'
  },
  {
    id: 'LP-R08',
    from: 'LEGAL-EDISCOVERY-COLLECTION',
    predicate: 'collected under',
    to: 'LEGAL-HOLD',
    cardinality: 'many-to-zero-or-many',
    governance: 'Collection retains hold/matter provenance.'
  },
  {
    id: 'LP-R09',
    from: 'PRIV-POLICY',
    ...
    governance: 'Policy content uses canonical controlled-information identity.'
  },
  {
    id: 'LP-R10',
    from: 'PRIV-PROCESSING-ACTIVITY',
    predicate: 'governed by',
    to: 'PRIV-FRAMEWORK',
    cardinality: 'many-to-one-or-many',
    governance: 'Applicable framework/version is retained.'
  },
  {
    id: 'LP-R11',
    from: 'PRIV-DPIA',
    predicate: 'assesses',
    to: 'PRIV-PROCESSING-ACTIVITY',
    cardinality: 'many-to-one-or-many',
    governance: 'DPIA remains assessment evidence, not processing identity.'
  },
  {
    id: 'LP-R12',
    from: 'PRIV-CONSENT-EVIDENCE',
    predicate: 'relates to',
    to: 'PRIV-PROCESSING-ACTIVITY',
    cardinality: 'many-to-zero-or-many',
    governance: 'Consent scope/purpose maps explicitly to processing.'
  },
  {
    id: 'LP-R13',
    from: 'PRIV-DATA-SUBJECT-REQUEST',
    predicate: 'may concern',
    to: 'PRIV-PROCESSING-ACTIVITY',
    cardinality: 'many-to-many',
    governance: 'Search/scope preserves exact processing context.'
  },
  {
    id: 'LP-R14',
    from: 'PRIV-INCIDENT',
    ...
    to: 'PRIV-PROCESSING-ACTIVITY',
    cardinality: 'many-to-many',
    governance: 'Affected processing scope remains explicit.'
  },
  {
    id: 'LP-R15',
    from: 'PRIV-INTERNATIONAL-TRANSFER',
    predicate: 'applies to',
    to: 'PRIV-PROCESSING-ACTIVITY',
    cardinality: 'many-to-many',
    governance: 'Transfer arrangement is connected to exact processing purpose/scope.'
  },
  {
    id: 'LP-R16',
    from: 'PRIV-ASSURANCE-REVIEW',
    predicate: 'reuses',
    to: 'QHSE-ASSURANCE-REVIEW',
    cardinality: 'many-to-one-pattern',
    governance: 'Privacy review uses the shared assurance-review occurrence architecture.'
  },
  {
    id: 'LP-R17',
    from: 'LEGAL-MATTER',
    ...
    to: 'CBO-CONTRACT',
    cardinality: 'many-to-many',
    governance: 'Legal matter references Contract without duplicating it.'
  },
  {
    id: 'LP-R18',
    from: 'LEGAL-MATTER',
    ...
    to: 'CBO-PARTY',
    cardinality: 'many-to-many',
    governance: 'Parties remain canonical identities.'
  },
  {
    id: 'LP-R19',
    from: 'LEGAL-IP-ASSET',
    ...
    to: 'CBO-PARTY',
    cardinality: 'many-to-one-or-many',
    governance: 'IP ownership references canonical Party and preserves history.'
  },
  {
    id: 'LP-R20',
    ...
    to: 'COMP-REQUIREMENT',
    cardinality: 'many-to-many',
    governance: 'Compliance requirement remains actionable/testable interpretation of source duty.'
  }
];
...
export function validateLegalPrivacyModel() {
  ...
  if (ids.size !== legalPrivacyModel.length || relIds.size !== legalPrivacyRelationships.length)
    return false;
  const candidates = new Set(legalPrivacyModel.flatMap((x) => x.candidateKeys));
  for (let i = 1; i <= 21; i += 1)
    if (!candidates.has(`BOF-22-${String(i).padStart(3, '0')}`)) return false;
  if (legalPrivacyModel.some((x) => !x.definition || !x.identityRule || !x.governance.length))
    return false;
  return legalPrivacyRelationships.every(
