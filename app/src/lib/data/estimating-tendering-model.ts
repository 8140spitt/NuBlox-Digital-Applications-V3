...
export const estimatingTenderingModel: EstimatingTenderingDefinition[] = [
  est(
    'EST-CUSTOMER-ENQUIRY',
    ['BOF-05-001', 'BOF-05-002'],
    'Customer Enquiry',
    'case',
    ...
    [
      'Invitation to Tender is a formal enquiry type, not a separate master architecture.',
      'Issued/amended tender information remains traceable.',
      'Customer identity is always the canonical Party/Party Relationship.'
    ]
  ),
  ...
  est(
    ...
    [
      ...
      'pricing date',
      'owner',
      'current approved/frozen version'
    ],
    [
      'Draft',
      'In Preparation',
    ...
    [
      'Estimate is not Project, WBS, Contract, Budget or Ledger truth.',
      'Approved/frozen estimate versions are immutable evidence.',
      'Downstream budgets and project controls reference the accepted estimate basis explicitly.'
    ]
  ),
  ...
  est(
    ...
    [
      'Version is not a duplicate Estimate master.',
      'Changes after freeze create a successor version.',
      'The exact version used for a Proposal/Quotation remains permanently traceable.'
    ]
  ),

  est(
    'EST-BREAKDOWN-ITEM',
    ['BOF-05-005', 'BOF-05-010'],
    ...
    ['Working', 'Frozen'],
    [
      'Estimate breakdown is not WBS, Cost Code, GL Account, BOQ or Procurement Package identity.',
      'Mappings to downstream structures are explicit.',
      'Preliminaries use the same controlled breakdown structure.'
    ]
  ),
  ...
  est(
    ...
    [
      'Take-off does not become Information Container identity.',
      'Source revision/provenance is explicit.',
      'Re-measurement creates retained history rather than overwriting frozen evidence.'
    ]
  ),
  ...
  est(
    ...
    [
      'Measurement Item is not an Asset, Item master or WBS node.',
      'Quantity is evidence-backed and historically reproducible.'
    ]
  ),
  ...
  est(
    ...
    [
      ...
      'UOM',
      'source rate',
      'waste/productivity factor',
      'calculated cost'
    ],
    ['Working', 'Frozen'],
    [
      'Build-up references shared Items/resources and never creates duplicate material/plant/labour masters.',
      'Historic source rates and factors are retained.'
    ]
  ),
  ...
  est(
    ...
    ['Working', 'Frozen'],
    [
      'Estimate Rate may reference Price List/Commercial Rate but retains the exact rate actually applied.',
      'Rate changes do not rewrite prior frozen estimate versions.'
    ]
  ),

  est(
    'EST-PROVISION',
    ['BOF-05-011', 'BOF-05-012'],
    'Estimate Provision',
    'child',
    ...
    [
      'Allowance and Contingency are provision types rather than parallel roots.',
      'Provision must retain rationale and avoid hidden double counting.',
      'Risk/provision does not become a finance reserve or project risk identity automatically.'
    ]
  ),
  ...
  est(
    ...
    [
      'Tender Package is not Procurement Package, Commercial Package, WBS or Contract.',
      'Mappings to estimate breakdown and downstream package structures are explicit.'
    ]
  ),

  est(
    'EST-TENDER-ADJUDICATION',
    ['BOF-05-019'],
    'Tender Adjudication',
    'event-evidence',
    ...
    ['Recorded'],
    [
      'Tender Adjudication is not supplier Sourcing Evaluation.',
      'Adjudication cannot silently edit the Estimate Version it approves.',
      'Protected approval requires contextual permission and authority.'
    ]
  ),
  ...
  est(
    ...
    [
      'Proposal is not Estimate, Quotation, Contract or Project.',
      'Issued versions are immutable evidence and remain linked to their pricing basis.'
    ]
  ),
  ...
  est(
    ...
    [
      'Quotation is not the internal Estimate and is not a Contract.',
      'Acceptance references the exact issued quotation version.',
      'Changing an Estimate does not alter an already issued Quotation.'
    ]
  ),
  ...
  est(
    ...
    [
      'Sales Order is distinct from Contract and Project.',
      'Where a formal Contract governs the order, the relationship is explicit rather than identity reuse.',
      'Order amendments retain commercial history.'
    ]
  ),

  est(
    'EST-OFFER-ACCEPTANCE',
    ['BOF-05-023'],
    'Offer Acceptance',
    'event-evidence',
    ...
    [
      'Acceptance is evidence, not Contract or Sales Order identity.',
      'Downstream commitment creation is an explicit domain action with retained provenance.'
    ]
  )
];
...
export const estimatingTenderingRelationships: EstimatingTenderingRelationship[] = [
  {
    id: 'EST-R01',
    from: 'EST-CUSTOMER-ENQUIRY',
    predicate: 'relates to',
    to: 'CRM-OPPORTUNITY',
    cardinality: 'many-to-one',
    governance: 'Commercial enquiry references Opportunity without changing Opportunity identity.'
  },
  {
    id: 'EST-R02',
    from: 'EST-ESTIMATE',
    predicate: 'prices',
    to: 'EST-CUSTOMER-ENQUIRY',
    cardinality: 'many-to-one',
    governance: 'Estimate retains the enquiry basis it is answering.'
  },
  {
    id: 'EST-R03',
    from: 'EST-ESTIMATE',
    predicate: 'has version',
    to: 'EST-ESTIMATE-VERSION',
    cardinality: 'one-to-many',
    governance: 'Stable Estimate identity owns controlled versions.'
  },
  {
    id: 'EST-R04',
    from: 'EST-ESTIMATE-VERSION',
    predicate: 'contains',
    to: 'EST-BREAKDOWN-ITEM',
    cardinality: 'one-to-many',
    governance: 'Breakdown structure belongs to exact Estimate Version.'
  },
  {
    id: 'EST-R05',
    from: 'EST-TAKEOFF',
    ...
    to: 'EST-ESTIMATE-VERSION',
    cardinality: 'many-to-one',
    governance: 'Take-off source/version is retained for exact estimate context.'
  },
  {
    id: 'EST-R06',
    from: 'EST-TAKEOFF',
    predicate: 'contains',
    to: 'EST-MEASUREMENT-ITEM',
    cardinality: 'one-to-many',
    governance: 'Measurement lines remain subordinate evidence.'
  },
  {
    id: 'EST-R07',
    from: 'EST-BREAKDOWN-ITEM',
    predicate: 'costed by',
    to: 'EST-RESOURCE-BUILDUP',
    cardinality: 'one-to-many',
    governance: 'Build-up is contextual to estimate breakdown rather than a resource master.'
  },
  {
    id: 'EST-R08',
    from: 'EST-RESOURCE-BUILDUP',
    predicate: 'produces/uses',
    to: 'EST-RATE',
    cardinality: 'one-to-many',
    governance: 'Rate retains its exact estimating basis.'
  },
  {
    id: 'EST-R09',
    from: 'EST-ESTIMATE-VERSION',
    ...
    to: 'EST-PROVISION',
    cardinality: 'one-to-many',
    governance: 'Allowance/contingency basis is explicit and versioned.'
  },
  {
    id: 'EST-R10',
    from: 'EST-CUSTOMER-ENQUIRY',
    predicate: 'organised by',
    to: 'EST-TENDER-PACKAGE',
    cardinality: 'one-to-many',
    governance: 'Tender package is bid-side scope grouping only.'
  },
  {
    id: 'EST-R11',
    from: 'EST-TENDER-PACKAGE',
    predicate: 'market tested via',
    to: 'PROC-SOURCING-REQUEST',
    cardinality: 'many-to-many',
    governance: 'Estimating supplier/subcontract enquiries reuse shared sourcing request semantics.'
  },
  {
    id: 'EST-R12',
    ...
    cardinality: 'one-to-many',
    governance: 'Quote/bid returns retain submission evidence in shared sourcing model.'
  },
  {
    id: 'EST-R13',
    from: 'PROC-SOURCING-RESPONSE',
    predicate: 'evaluated by',
    to: 'PROC-EVALUATION',
    cardinality: 'many-to-one-or-many',
    governance: 'Comparison is governed sourcing evaluation, not a separate estimate master.'
  },
  {
    id: 'EST-R14',
    from: 'EST-TENDER-ADJUDICATION',
    predicate: 'approves basis of',
    to: 'EST-ESTIMATE-VERSION',
    cardinality: 'many-to-one',
    governance: 'Adjudication binds exact frozen version and authority evidence.'
  },
  {
    id: 'EST-R15',
    from: 'EST-PROPOSAL',
    predicate: 'priced from',
    to: 'EST-ESTIMATE-VERSION',
    cardinality: 'many-to-one',
    governance:
      'Proposal retains exact internal pricing basis without exposing/reusing estimate identity.'
  },
  {
    id: 'EST-R16',
    from: 'EST-QUOTATION',
    ...
    to: 'EST-ESTIMATE-VERSION',
    cardinality: 'many-to-one',
    governance: 'Issued quote remains bound to its estimate version.'
  },
  {
    id: 'EST-R17',
    from: 'EST-OFFER-ACCEPTANCE',
    predicate: 'accepts',
    to: 'EST-QUOTATION',
    cardinality: 'many-to-one',
    governance: 'Acceptance binds exact issued offer version.'
  },
  {
    id: 'EST-R18',
    from: 'EST-OFFER-ACCEPTANCE',
    ...
    governance: 'Commitment creation is explicit and retains acceptance provenance.'
  },
  {
    id: 'EST-R19',
    from: 'EST-OFFER-ACCEPTANCE',
    ...
    governance: 'Contract identity is created/governed separately from offer acceptance.'
  }
];

export const estimatingTenderingBoundaries: EstimatingTenderingBoundary[] = [
  {
    name: 'Estimate identity',
    structure: 'Estimate → Version → Breakdown / Take-off / Build-up / Provision',
    purpose: 'Preserve exact internal pricing basis and history.',
    mustNotBecome: 'Project / WBS / Budget / GL / Contract'
  },
  {
    name: 'Bid-side scope',
    structure: 'Customer Enquiry → Tender Package → Estimate',
    purpose: 'Organise what the customer is asking NuBlox enterprise to price.',
    mustNotBecome: 'Procurement Package / Commercial Package / Work Package'
  },
  {
    name: 'Market testing',
    structure: 'Sourcing Request → Response → Evaluation',
    purpose: 'Reuse supplier/subcontract sourcing evidence during estimating.',
    mustNotBecome: 'A second estimating-only supplier tender engine'
  },
  {
    name: 'Customer offer',
    structure: 'Proposal / Quotation → Acceptance → Sales Order / Contract',
    purpose: 'Separate internal cost basis from external offer and commitment.',
    mustNotBecome: 'Estimate renamed into Contract or Project'
  }
];
...
export function validateEstimatingTenderingModel() {
  ...
  const external = new Set([
    'CRM-OPPORTUNITY',
    'PROC-SOURCING-REQUEST',
    'PROC-SOURCING-RESPONSE',
    'PROC-EVALUATION',
    'CBO-CONTRACT'
  ]);
  ...
  if (
    estimatingTenderingModel.some(
      (item) =>
        !item.canonicalName || !item.definition || !item.identityRule || !item.governance.length
    )
  )
    return false;
  if (estimatingTenderingRelationships.some((rel) => !ids.has(rel.from) && !external.has(rel.from)))
    return false;
  if (estimatingTenderingRelationships.some((rel) => !ids.has(rel.to) && !external.has(rel.to)))
    return false;
  return true;
}
