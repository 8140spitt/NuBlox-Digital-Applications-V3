...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed storage, reservation, movement, stock-control and logistics execution semantics.
        Item identity, quantity, traceability, storage and delivery are deliberately separate
        layers.
      </p>
    </div>
    <div class="hero-actions">
      <a href={`/${data.tenantSlug}/app/admin/business-objects`}>← Canonicalization workbench</a>
      <a href={`/${data.tenantSlug}/app/admin/business-objects/item-manufacturing`}
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed inventory and logistics constructs</h2>
      </div>
      <p>
        Each construct defines identity, scope, lifecycle and the boundary that prevents duplicate
        stock or logistics truth.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How inventory truth and logistics execution connect</h2>
      </div>
      <p>
        Relationships preserve source/destination, demand, traceability and custody without
        collapsing the semantic layers.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each inventoryLogisticsRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
...
<style>
  ...
  .hero {
    ...
    align-items: center;
    padding: 20px;
    background: linear-gradient(120deg, #fbfdff, #eef8f3 65%, #fff);
  }
  .eyebrow {
    color: var(--blue-700);
    font-size: 10px;
