...
<div class="page">
  ...
  <section class="metrics">
    ...
    <article class="section-card"><span>Benchmark gaps</span><strong>{coverageAuditSummary.externalBenchmark.benchmarkGapResolvedCount}/{coverageAuditSummary.externalBenchmark.benchmarkGapCount}</strong><small>resolved · {coverageAuditSummary.externalBenchmark.benchmarkGapOpenCount} open cross-benchmark questions</small></article>
  </section>
  ...
  <section class="section-card lenses">
    ...
    <div class="lens-grid">
      ...
      <article><strong>5 · External benchmark</strong><p>{coverageAuditSummary.externalBenchmark.name}: {coverageAuditSummary.externalBenchmark.registeredBenchmarks} registered tools across {coverageAuditSummary.externalBenchmark.requiredDomains} workspaces; {coverageAuditSummary.externalBenchmark.challengedBenchmarks} challenged · {coverageAuditSummary.externalBenchmark.inProgressBenchmarks} in progress · {coverageAuditSummary.externalBenchmark.registeredBenchmarksPending} queued. {coverageAuditSummary.externalBenchmark.mandatorySuites} mandatory suites + {coverageAuditSummary.externalBenchmark.specialistDepthBenchmarks} specialist depth benchmarks. SAP V3 remap: {coverageAuditSummary.externalBenchmark.sapV3MappedRows}/{coverageAuditSummary.externalBenchmark.legacySapCapabilityRows}; challenged: {coverageAuditSummary.externalBenchmark.sapV3ChallengedRows}/{coverageAuditSummary.externalBenchmark.legacySapCapabilityRows}; closed: {coverageAuditSummary.externalBenchmark.sapV3ClosedRows}/{coverageAuditSummary.externalBenchmark.legacySapCapabilityRows}. Status remains {coverageAuditSummary.externalBenchmark.state}.</p></article>
    </div>
  </section>
