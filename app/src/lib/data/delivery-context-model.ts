...
export const deliveryContextModel: DeliveryContextDefinition[] = [
  {
    ...
    definition:
      'A governed collection of investments, programmes and projects managed together to achieve strategic outcomes and optimise enterprise resources.',
    identityRule:
      'Stable Portfolio identity independent of the projects/programmes currently associated with it.',
  ...
  },
  {
    ...
    kind: 'governance-context',
    definition:
      'A coordinated governance context for related projects and change activities managed together to realise outcomes and benefits.',
    identityRule:
      'Stable Programme identity; its constituent Projects remain independent canonical identities.',
  ...
  },
  {
    ...
    definition:
      'The stable governed delivery identity defined by the foundation object model and reused across every delivery structure.',
    identityRule:
      'One immutable Project identity survives stage changes, rebaselines, organisational change, contract changes and handover.',
  ...
  },
  {
    ...
    definition:
      'An effective assignment of a governed project phase/stage definition to a Project, optionally carrying planned/actual dates and gate status.',
    identityRule:
      'Stage/phase is contextual classification of the Project; it never creates a new Project identity.',
  ...
  },
  {
    ...
    definition:
      'A stable node in a project Work Breakdown Structure used to decompose and control delivery scope.',
    identityRule:
      'Immutable WBS Element identity within a Project; code/title/hierarchy may change under governed change while history is retained.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A governed package of project delivery scope that can be assigned, planned, controlled and evidenced as a coherent unit of work.',
    identityRule:
      'Stable Work Package identity linked to Project/WBS scope; schedule activities and commercial packages reference it rather than replace it.',
  ...
  },
  {
    ...
    kind: 'plan',
    definition:
      'A time-planning network for a Project, Programme or governed delivery context containing activities, milestones and dependencies.',
    identityRule:
      'Stable Schedule identity; updates change the current working plan while approved baselines remain immutable separate records.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A planned unit of time-based work within a Schedule, with duration, dates, progress and network relationships.',
    identityRule:
      'Stable activity identity within its Schedule; activity code is a governed business identifier.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A zero-duration schedule marker representing a significant planned or achieved point in time.',
    identityRule:
      'Stable Milestone identity within a Schedule; it can reference a gate, contractual key date or completion event without becoming that object.',
  ...
  },
  {
    ...
    kind: 'plan',
    definition:
      'An immutable approved snapshot of a Schedule used as a governed comparison point for performance and change control.',
    identityRule:
      'Each baseline has its own immutable identity and approval/effective date while referencing one Schedule.',
  ...
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'An as-of-date evidence record describing measured progress against a governed delivery object such as an Activity or Work Package.',
    identityRule:
      'Immutable observation/event identity; corrections create explicit correction/supersession evidence rather than silent overwrite.',
    scope: ['project', 'activity', 'work package', 'reporting period'],
    keyData: [
      'subject',
      'as-of date/time',
      'measure',
      'quantity/percent where applicable',
      'source',
      'actor',
      'evidence'
    ],
  ...
  },
  {
    ...
    kind: 'plan',
    definition:
      'A planned need for a classified resource, quantity/capacity and time window against delivery scope or scheduled work.',
    identityRule:
      'Stable requirement identity; fulfilment/allocation is a separate relationship and does not rewrite the requirement.',
  ...
  },
  {
    ...
    kind: 'constraint',
    definition:
      'A governed delivery/project constraint that limits or blocks planned work, access, information, resources, sequence or conditions.',
    identityRule:
      'Stable constraint identity shared by project controls and field operations, retaining exact source, scope, impact, owner and resolution history.',
...
export const deliveryContextRelationships: DeliveryContextRelationship[] = [
  {
    ...
    to: 'DEL-PROGRAMME',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Portfolio Membership',
    governance: 'Membership is effective-dated; Programme identity remains independent.'
  },
  {
    id: 'DEL-R02',
    from: 'DEL-PORTFOLIO',
    ...
    to: 'CBO-PROJECT',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Portfolio Project Membership',
    governance: 'Projects may be portfolio-governed without a Programme.'
  },
  {
    id: 'DEL-R03',
    from: 'DEL-PROGRAMME',
    ...
    to: 'CBO-PROJECT',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Programme Project Membership',
    governance: 'Effective association; no duplicate Project master.'
  },
  {
    id: 'DEL-R04',
    from: 'CBO-PROJECT',
    predicate: 'classified through',
    to: 'DEL-STAGE-ASSIGNMENT',
    cardinality: '1 ↔ 0..*',
    governance:
      'Assignments reference configured Project Stage Definitions and retain dates/history.'
  },
  {
    id: 'DEL-R05',
    from: 'CBO-PROJECT',
    predicate: 'decomposed by',
    to: 'DEL-WBS-ELEMENT',
    cardinality: '1 ↔ 0..*',
    governance: 'WBS is the controlled scope hierarchy.'
  },
  {
    id: 'DEL-R06',
    from: 'DEL-WBS-ELEMENT',
    predicate: 'parent of',
    to: 'DEL-WBS-ELEMENT',
    cardinality: '0..1 ↔ 0..*',
    governance: 'Hierarchy changes are controlled/effective and cannot create cycles.'
  },
  {
    id: 'DEL-R07',
    from: 'DEL-WBS-ELEMENT',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: '0..* ↔ 0..*',
    governance: 'Work Package scope mapping is explicit; package identity is independent.'
  },
  {
    id: 'DEL-R08',
    from: 'CBO-PROJECT',
    predicate: 'planned by',
    to: 'DEL-SCHEDULE',
    cardinality: '1 ↔ 0..*',
    governance: 'Schedule purpose/ownership must be explicit where multiple schedules exist.'
  },
  {
    id: 'DEL-R09',
    from: 'DEL-SCHEDULE',
    predicate: 'contains',
    to: 'DEL-SCHEDULE-ACTIVITY',
    cardinality: '1 ↔ 0..*',
    governance:
      'Activity identity belongs to one Schedule; cross-schedule mappings are separate relationships.'
  },
  {
    id: 'DEL-R10',
    from: 'DEL-SCHEDULE',
    ...
    to: 'DEL-MILESTONE',
    cardinality: '1 ↔ 0..*',
    governance: 'Milestone may reference business gates/key dates but does not replace them.'
  },
  {
    id: 'DEL-R11',
    from: 'DEL-SCHEDULE',
    ...
    cardinality: '1 ↔ 0..*',
    governance: 'Approved baselines are immutable and superseded, never overwritten.'
  },
  {
    id: 'DEL-R12',
    ...
    to: 'DEL-SCHEDULE-ACTIVITY',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Dependency',
    governance: 'Dependency carries relationship type, lag/lead and planning provenance.'
  },
  {
    id: 'DEL-R13',
    from: 'DEL-SCHEDULE-ACTIVITY',
    ...
    to: 'DEL-WBS-ELEMENT',
    cardinality: '0..* ↔ 0..*',
    governance: 'Schedule network and WBS hierarchy remain independent structures.'
  },
  {
    id: 'DEL-R14',
    from: 'DEL-SCHEDULE-ACTIVITY',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: '0..* ↔ 0..*',
    governance: 'Many activities may execute one package and vice versa where justified.'
  },
  {
    id: 'DEL-R15',
    from: 'DEL-PROGRESS-RECORD',
    predicate: 'evidences',
    to: 'DEL-SCHEDULE-ACTIVITY',
    cardinality: '0..* ↔ 1',
    governance: 'Progress history is append-only/correctable evidence.'
  },
  {
    id: 'DEL-R16',
    from: 'DEL-PROGRESS-RECORD',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: '0..* ↔ 1',
    governance: 'Package progress may be derived from validated evidence and lower-level work.'
  },
  {
    id: 'DEL-R17',
    from: 'DEL-RESOURCE-REQUIREMENT',
    predicate: 'required by',
    to: 'DEL-SCHEDULE-ACTIVITY',
    cardinality: '0..* ↔ 0..*',
    governance: 'Requirement and allocation are separate.'
  },
  {
    id: 'DEL-R18',
    from: 'DEL-RESOURCE-REQUIREMENT',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: '0..* ↔ 0..*',
    governance: 'Requirements can be planned at the scope level before detailed activities exist.'
  },
  {
    id: 'DEL-R19',
    from: 'DEL-CONSTRAINT',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: '0..* ↔ 0..*',
    governance: 'Constraint scope is explicit and does not become Work Package state.'
  },
  {
    id: 'DEL-R20',
    from: 'DEL-CONSTRAINT',
    predicate: 'may constrain',
    to: 'DEL-SCHEDULE-ACTIVITY',
    cardinality: '0..* ↔ 0..*',
    governance:
      'Schedule impact and constraint identity remain separate so delay/forecast evidence is reconstructable.'
  }
];
...
export const deliveryStructureBoundaries: DeliveryStructureBoundary[] = [
  {
    ...
    purpose: 'Investment and outcome governance',
    structure: 'Portfolio → Programme → Project',
    mustNotBecome: 'Schedule/WBS/cost hierarchy'
  },
  {
    name: 'Stage model',
    purpose: 'Delivery maturity and gates',
    structure: 'Project → Delivery Stage Assignment → configured stage definition',
    mustNotBecome: 'Project lifecycle or approval workflow'
  },
  {
    name: 'Scope hierarchy',
    purpose: 'Decompose controlled project scope',
    structure: 'Project → WBS Element → Work Package',
    mustNotBecome: 'Schedule network or asset hierarchy'
  },
  {
    name: 'Time network',
    purpose: 'Plan sequence and dates',
    structure: 'Schedule → Activity / Milestone + Dependency',
    mustNotBecome: 'WBS or workflow task list'
  },
  {
    name: 'Commercial structure',
    purpose: 'Contractual/procurement commitments',
    structure: 'Contract / Commercial Package / Procurement Package',
    mustNotBecome: 'Work Package by default'
  },
  {
    name: 'Physical structure',
    purpose: 'Represent the built environment',
    structure: 'Site / System / Asset / Component',
    mustNotBecome: 'WBS or schedule nodes'
  },
  {
    name: 'Information structure',
    purpose: 'Controlled project/asset information',
    structure: 'Information Container + classification/relationships',
    mustNotBecome: 'Project folder tree as canonical business model'
  }
];
...
export function validateDeliveryContextModel() {
  ...
  for (const item of deliveryContextModel) {
    if (!item.modelId || ids.has(item.modelId))
      throw new Error(`Duplicate delivery model ID: ${item.modelId}`);
    if (
      ...
      throw new Error(`Incomplete delivery context definition: ${item.modelId}`);
  ...
  for (const relationship of deliveryContextRelationships) {
    if (!ids.has(relationship.from) || !ids.has(relationship.to))
      throw new Error(`Unknown delivery relationship endpoint: ${relationship.id}`);
  }
  return true;
}
