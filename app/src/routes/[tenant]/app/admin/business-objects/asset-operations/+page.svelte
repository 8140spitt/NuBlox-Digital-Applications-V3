...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed commissioning, handover, maintenance, service, reliability, warranty and
        operational evidence semantics built around one persistent System / Asset identity.
      </p>
    </div>
    <div class="hero-actions">
      ...
      >
      <a href={`/${data.tenantSlug}/app/admin/business-objects/inventory-logistics`}
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed operational constructs</h2>
      </div>
      <p>
        Each construct defines identity, scope, lifecycle and the boundary that prevents
        commissioning, FM and service activity from creating duplicate Asset truth.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How delivery becomes whole-life operations</h2>
      </div>
      <p>
        These links preserve provenance and responsibility without turning Project closeout into an
        Asset re-creation event.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each assetOperationsRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
...
<style>
  ...
  .hero {
    ...
    align-items: center;
    padding: 20px;
    background: linear-gradient(120deg, #fbfdff, #f2f5fb 65%, #fff);
  }
  .eyebrow {
    color: var(--blue-700);
    font-size: 10px;
