...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        One Person identity across recruitment, employment, position, competence, learning,
        scheduling, time, payroll and offboarding—with each business context retaining its own
        governed meaning.
      </p>
    </div>
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed workforce constructs</h2>
      </div>
      <p>
        Identity, organisation structure, competence evidence, work time and pay consequences remain
        connected without collapsing into one employee record.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How workforce truth connects</h2>
      </div>
      <p>
        Employment, organisational structure, competence, time and financial consequences reference
        the same worker identity while preserving domain authority.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each peopleHcmRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
