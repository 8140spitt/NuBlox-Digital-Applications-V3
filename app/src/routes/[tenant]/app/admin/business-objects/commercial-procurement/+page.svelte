<script lang="ts">
  ...
  let { data } = $props();
  const names = new Map(commercialProcurementModel.map((item) => [item.modelId, item.canonicalName]));
...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>Governed Contract, party-role, obligation, commercial-package, procurement-package, change, sourcing, award, commitment and receipt semantics. Delivery, commercial and procurement structures remain connected without being collapsed into one hierarchy.</p>
    </div>
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div><span class="eyebrow">Semantic contracts</span><h2>Governed commercial and procurement objects</h2></div>
      <p>Each construct defines stable identity, lifecycle, scope and the modelling boundary that prevents duplicate ERP truth.</p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div><span class="eyebrow">Relationship graph</span><h2>How commercial, delivery and sourcing structures connect</h2></div>
      <p>Relationship records can carry effectivity, authority, provenance and mapping metadata without changing the identity of either endpoint.</p>
    </div>
