...
export const itemManufacturingModel: ItemManufacturingDefinition[] = [
  {
    ...
    definition:
      'The stable reusable commercial/technical definition for a product, material or service that can be estimated, specified, sourced, priced, stocked, manufactured, sold or consumed.',
    identityRule:
      'One immutable Item identity; product/material/service meaning is classification and behaviour, not a parallel master.',
    scope: [
      'tenant',
      'legal entity where commercial governance differs',
      'catalogue/product-data context'
    ],
    keyData: [
      'item number',
      ...
      'status',
      'technical/commercial classifications'
    ],
  ...
  },
  {
    ...
    definition:
      'A governed technical/commercial specification of an Item or Item family, including required attributes, performance and compliance characteristics.',
    identityRule:
      'Stable specification identity with governed revisions/effectivity; Item identity remains unchanged when a specification revision changes.',
    scope: [
      'item',
      'item family/classification',
      'jurisdiction/project applicability where required'
    ],
    keyData: [
  ...
  },
  {
    ...
    kind: 'controlled-definition',
    definition:
      'A governed variant/configuration of an Item distinguished by selected characteristics while remaining part of the same product family.',
    identityRule:
      'Stable Variant identity linked to one base Item/family; configurable characteristics and effectivity are explicit.',
  ...
  },
  {
    ...
    kind: 'relationship',
    definition:
      'A governed relationship stating that one Item may substitute for another under explicit conditions, scope and effectivity.',
    identityRule:
      'Relationship identity between canonical Items; neither source nor substitute Item identity changes.',
  ...
  },
  {
    ...
    kind: 'relationship',
    definition:
      'A governed relationship linking a canonical Organisation/Party acting as manufacturer to an Item and its manufacturer-specific identity.',
    identityRule:
      'Relationship identity; manufacturer part numbers are external/business identifiers, not replacement NuBlox Item identities.',
  ...
  },
  {
    ...
    kind: 'relationship',
    definition:
      'A governed commercial relationship between a supplier Party and an Item, carrying supplier-specific identifiers, ordering constraints and commercial applicability.',
    identityRule:
      'Relationship identity; supplier SKU/catalogue references do not replace Item identity.',
  ...
  },
  {
    ...
    definition:
      'A governed collection/view of Items offered, procurable or otherwise available within a defined commercial context.',
    ...
    keyData: [
      'catalogue code',
      'owner/context',
      'currency/market where applicable',
      'effective dates',
      'membership'
    ],
  ...
  },
  {
    ...
    kind: 'commercial-definition',
    definition:
      'An effective-dated governed set of commercial rates/prices for Items, services or resource classifications within a defined context.',
    identityRule:
      'Stable Price List identity; price/rate entries are effective-dated children and do not alter Item identity.',
  ...
  },
  {
    ...
    kind: 'foundation-reference',
    definition:
      'Shared governed reference data defining measurable units and permitted conversions used across Items, quantities, costs and operations.',
    identityRule:
      'One canonical unit code/identity; context-specific aliases map to it rather than creating duplicate unit definitions.',
  ...
  },
  {
    ...
    kind: 'structure',
    definition:
      'A governed product/material structure defining component Items and quantities required to realise a parent Item or manufacturing definition.',
    identityRule:
      'Stable BOM identity/version associated with a parent Item/manufacturing definition; approved versions are immutable.',
  ...
  },
  {
    ...
    kind: 'controlled-definition',
    definition:
      'The governed manufacturing configuration for producing an Item, tying together applicable BOM, process plan/routing, resources and effectivity.',
    identityRule:
      'Stable manufacturing-definition identity/version linked to the Item; it does not replace Item identity.',
    ...
    keyData: [
      ...
      'BOM',
      'process plan',
      'site/work-centre applicability',
      'effectivity'
    ],
    lifecycle: ['Draft', 'Review', 'Approved', 'Effective', 'Superseded', 'Obsolete'],
    governance: [
  ...
  },
  {
    ...
    kind: 'controlled-definition',
    definition:
      'A governed sequence/structure of manufacturing operations, routing and required resources used to produce an Item.',
    identityRule:
      'Stable process-plan identity/version; routing is a controlled structure within the plan rather than a duplicate product identity.',
    scope: ['manufacturing definition', 'site/work centre'],
    keyData: [
      'process-plan number/version',
      'operations/routing',
      'work centres',
      'standard times',
      'required resources'
  ...
  },
  {
    ...
    definition:
      'A governed production-capacity context representing where/how manufacturing operations are performed, linked to organisation, site and assets as applicable.',
    identityRule:
      'Stable Work Centre identity; underlying Site, Organisation Unit and Asset identities remain canonical in their own models.',
  ...
  },
  {
    ...
    kind: 'work',
    definition:
      'A governed execution order authorising production of a specified Item/configuration and quantity using a manufacturing definition/process plan.',
    identityRule:
      'Stable order identity; Production Plan supplies planning context and Production Operations are child execution steps.',
    scope: [
      'manufacturing site/work centre',
      'item/manufacturing definition',
      'project/customer order where relevant'
    ],
    keyData: [
      'order number',
      'Item/configuration',
  ...
  },
  {
    ...
    definition:
      'A traceable quantity identity grouping Item quantity produced, received or otherwise controlled together under common provenance.',
    identityRule:
      'Stable Lot identity tied to one Item/configuration and provenance; quantity movements do not change the lot identity.',
  ...
  },
  {
    ...
    kind: 'traceability-identity',
    definition:
      'A traceable production/process grouping representing quantity produced or processed together under common execution conditions.',
    identityRule:
      'Stable Batch identity linked to Item/manufacturing execution; batch lineage is retained across splits/merges where allowed.',
  ...
  },
  {
    ...
    kind: 'traceability-identity',
    definition:
      'A unique traceability identity for an individual Item instance before or independent of installed Asset registration.',
    identityRule:
      'Stable serial identity scoped by Item/manufacturer rules; serial value is a governed business identifier.',
  ...
  },
  {
    ...
    kind: 'event-evidence',
    definition:
      'The evidenced actual configuration/provenance of manufactured output, including actual components, batches/lots/serials, process completion and quality evidence.',
    identityRule:
      'Immutable configuration/evidence snapshot per produced unit/batch/lot or governed output; corrections are explicit events.',
    scope: ['production order', 'produced lot/batch/serial', 'item/manufacturing definition'],
    keyData: [
      'actual components/materials',
      'lot/batch/serial genealogy',
      'operations/work centres',
      'quality records',
...
export const itemManufacturingRelationships: ItemManufacturingRelationship[] = [
  {
    ...
    to: 'ITEM-SPECIFICATION',
    cardinality: '1 ↔ 0..*',
    governance: 'Specifications are versioned/effective; Item identity remains stable.'
  },
  {
    id: 'IM-R02',
    from: 'CBO-ITEM',
    ...
    to: 'ITEM-VARIANT',
    cardinality: '1 ↔ 0..*',
    governance: 'Variant remains configuration, not serial/asset identity.'
  },
  {
    id: 'IM-R03',
    from: 'CBO-ITEM',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Item Substitution',
    governance: 'Conditions, approval and effectivity belong to the relationship.'
  },
  {
    id: 'IM-R04',
    from: 'CBO-ITEM',
    predicate: 'manufactured by',
    to: 'ITEM-MANUFACTURER-REL',
    cardinality: '1 ↔ 0..*',
    governance:
      'Relationship links Item to canonical manufacturer Party and external manufacturer ID.'
  },
  {
    id: 'IM-R05',
    from: 'CBO-ITEM',
    predicate: 'supplied through',
    to: 'ITEM-SUPPLIER-REL',
    cardinality: '1 ↔ 0..*',
    governance: 'Supplier-item relation carries supplier-specific commercial ordering data.'
  },
  {
    id: 'IM-R06',
    from: 'ITEM-CATALOGUE',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Catalogue Membership',
    governance: 'Catalogue membership is effective; no duplicate Item master.'
  },
  {
    id: 'IM-R07',
    ...
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Price/Rate Entry',
    governance: 'Entry carries currency, quantity break, context and effectivity.'
  },
  {
    id: 'IM-R08',
    from: 'CBO-ITEM',
    ...
    cardinality: '1 ↔ 1',
    governance:
      'Base UOM is governed reference data; alternative transaction units require valid conversion.'
  },
  {
    id: 'IM-R09',
    from: 'ITEM-BOM',
    predicate: 'defines structure for',
    to: 'CBO-ITEM',
    cardinality: '0..* ↔ 1',
    governance: 'One effective BOM/version applies according to configuration/effectivity rules.'
  },
  {
    id: 'IM-R10',
    from: 'ITEM-BOM',
    predicate: 'contains component',
    to: 'CBO-ITEM',
    cardinality: '1 ↔ 0..*',
    relationshipObject: 'BOM Line',
    governance:
      'BOM line carries quantity/UOM, position, effectivity and substitute/alternate rules.'
  },
  {
    id: 'IM-R11',
    from: 'MFG-DEFINITION',
    ...
    cardinality: '0..* ↔ 1',
    governance:
      'Manufacturing definition is version/effectivity controlled and never replaces Item identity.'
  },
  {
    id: 'IM-R12',
    from: 'MFG-DEFINITION',
    ...
    to: 'ITEM-BOM',
    cardinality: '0..* ↔ 0..*',
    governance: 'Applicable BOM version is governed by manufacturing-definition effectivity.'
  },
  {
    id: 'IM-R13',
    from: 'MFG-DEFINITION',
    ...
    to: 'MFG-PROCESS-PLAN',
    cardinality: '0..* ↔ 1..*',
    governance: 'Process plan/routing is controlled separately from BOM/product structure.'
  },
  {
    id: 'IM-R14',
    from: 'MFG-PROCESS-PLAN',
    predicate: 'performed at',
    to: 'MFG-WORK-CENTRE',
    cardinality: '0..* ↔ 0..*',
    relationshipObject: 'Operation Resource Requirement',
    governance:
      'Definitions state required/allowed work centres; execution captures actual centre/resource.'
  },
  {
    id: 'IM-R15',
    from: 'MFG-PRODUCTION-ORDER',
    predicate: 'executes',
    to: 'MFG-DEFINITION',
    cardinality: '0..* ↔ 1',
    governance: 'Order records the manufacturing-definition version actually authorised.'
  },
  {
    id: 'IM-R16',
    from: 'MFG-PRODUCTION-ORDER',
    ...
    to: 'TRACE-LOT',
    cardinality: '0..* ↔ 0..*',
    governance: 'Lot provenance retains the producing order.'
  },
  {
    id: 'IM-R17',
    from: 'MFG-PRODUCTION-ORDER',
    ...
    to: 'TRACE-BATCH',
    cardinality: '0..* ↔ 0..*',
    governance: 'Batch genealogy retains production execution/provenance.'
  },
  {
    id: 'IM-R18',
    from: 'MFG-PRODUCTION-ORDER',
    ...
    to: 'TRACE-SERIAL',
    cardinality: '0..* ↔ 0..*',
    governance: 'Serialized output retains order/item/manufacturer provenance.'
  },
  {
    id: 'IM-R19',
    from: 'MFG-PRODUCTION-ORDER',
    predicate: 'evidenced by',
    to: 'MFG-AS-MANUFACTURED',
    cardinality: '1 ↔ 0..*',
    governance:
      'Actual configuration/evidence is immutable and linked to output traceability identities.'
  }
];
...
export const itemManufacturingBoundaries: ItemManufacturingBoundary[] = [
  {
    name: 'Definition',
    structure: 'Item → Specification / Variant',
    purpose: 'Reusable product/material/service meaning.',
    mustNotBecome: 'stock instance, Asset or project-specific duplicate master'
  },
  {
    name: 'Commercial',
    structure: 'Catalogue / Price List ↔ Item',
    purpose: 'Availability, supplier/customer/channel and pricing context.',
    mustNotBecome: 'Item identity or transactional invoice/order history'
  },
  {
    name: 'Product structure',
    structure: 'Item → BOM → component Items',
    purpose: 'Governed technical/material composition.',
    mustNotBecome: 'WBS, Asset hierarchy or installed configuration'
  },
  {
    name: 'Manufacturing',
    structure: 'Manufacturing Definition → Process Plan → Work Centre',
    purpose: 'How an Item is produced.',
    mustNotBecome: 'Item master or production execution history'
  },
  {
    name: 'Traceability',
    structure: 'Lot / Batch / Serial',
    purpose: 'Actual quantity/unit provenance.',
    mustNotBecome: 'Item definition or automatically an Asset'
  },
  {
    name: 'Actual configuration',
    structure: 'Production Order → As-Manufactured Configuration',
    purpose: 'Evidence of what was actually produced.',
    mustNotBecome: 'approved design/manufacturing definition'
  }
];
...
export function validateItemManufacturingModel() {
  ...
  for (const item of itemManufacturingModel) {
    if (!item.modelId || ids.has(item.modelId))
      throw new Error(`Duplicate item/manufacturing model ID: ${item.modelId}`);
    if (
      ...
      throw new Error(`Incomplete item/manufacturing definition: ${item.modelId}`);
    ids.add(item.modelId);
  }
  for (const rel of itemManufacturingRelationships) {
    if (!ids.has(rel.from) || !ids.has(rel.to))
      throw new Error(`Unknown relationship endpoint: ${rel.id}`);
  }
  return true;
}
