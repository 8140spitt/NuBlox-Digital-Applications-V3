    ...
    {:else}
      <div class="gap-grid">
        <article>
          ...
          <small>Duplicate/alias convergence, Gate 3 and the canonical aggregate-boundary freeze are closed. Next gate: L2/L3 activity → object/action mapping.</small>
        </article>
      </div>
    {/if}
  </section>
