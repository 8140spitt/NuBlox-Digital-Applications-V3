...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed Portfolio, Programme, Project, stage, WBS, work-package, schedule, baseline,
        progress and resource-planning semantics. These structures are related deliberately without
        being collapsed into one hierarchy.
      </p>
    </div>
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed delivery constructs</h2>
      </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How the delivery structures connect</h2>
      </div>
      <p>
        Cardinality is logical guidance. Relationship records can carry effectivity, provenance,
        role and control metadata.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each deliveryContextRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
...
<style>
  ...
  .boundary-grid article:nth-child(4n) {
    border-right: 0;
  }
  .boundary-grid h2 {
    font-size: 12px;
