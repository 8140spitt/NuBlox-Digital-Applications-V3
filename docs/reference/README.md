...
- [PTC Windchill Customization & Extension Matrix](windchill-customization-extension-matrix.csv) — machine-readable extension-layer, semantic-boundary and upgrade-risk crosswalk.\n- [PTC Windchill Business Administrative Change Promotion Model](windchill-business-administrative-change-model.md) — controlled promotion of administrative configuration using environment identity, baselines, deltas, packages, mappings, conflict resolution and import evidence.\n- [PTC Windchill Business Administrative Change Matrix](windchill-business-administrative-change-matrix.csv) — machine-readable configuration-promotion crosswalk.\n- [PTC Windchill Purge, Archive, Restore & Retention Model](windchill-purge-archive-retention-model.md) — separates governed object/iteration disposition and archive/restore from ordinary delete and disaster-recovery backup.\n- [PTC Windchill Purge/Archive/Retention Matrix](windchill-purge-archive-retention-matrix.csv) — machine-readable policy/query/schedule/job/conflict/archive/restore crosswalk.\n- [PTC Windchill Help Center Top-Level Reconciliation](windchill-help-center-top-level-reconciliation.csv) — maps the Help Center top-level capability branches to the evidence/coverage IDs and isolates genuine CBE gaps.
- [PTC Windchill Collaboration & Business Rules Model](windchill-collaboration-business-rules-model.md) — separates Meetings, Discussions, Notebooks and Context Networks from governed Workflow, and separates reusable validation/association/mapping rules from lifecycle and routing.
