...
Total explicit/candidate Work-Product evidence: 262 jobs / 1,604 Work Products
```
...
Work-Product decomposition is now explicit for **262 / 462** candidate employment jobs. **200 jobs remain** without explicit Work-Product decomposition. Waves 5-7 use exact source Activity IDs and Work-Product-family classification as the stronger J1 standard.
