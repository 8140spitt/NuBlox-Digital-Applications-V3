...
let oidcServiceInstance: MySqlOidcService | undefined;
...
export function getTenantRoutingRepository(): MySqlTenantRoutingRepository {
  if (!tenantRoutingRepositoryInstance) {
...
export function getMfaService(): MySqlMfaService {
  if (!mfaServiceInstance) {
    mfaServiceInstance = new MySqlMfaService(getDatabasePool());
  }
  return mfaServiceInstance;
}

export function getTenantAuthenticationPolicyRepository(): MySqlTenantAuthenticationPolicyRepository {
  if (!tenantAuthenticationPolicyRepositoryInstance) {
    tenantAuthenticationPolicyRepositoryInstance =
...
export function getOidcService(): MySqlOidcService {
  if (!oidcServiceInstance) {
    oidcServiceInstance = new MySqlOidcService(getDatabasePool());
  }
