...
export const siteFieldOperationsModel: SiteFieldOperationsDefinition[] = [
  field(
    ...
    ['Site reference', 'Project context', 'field-operation applicability'],
    ['Referenced'],
    [
      'Site identity is owned by the built-environment model.',
      'Field status never changes Site identity.'
    ]
  ),
  ...
  field(
    ...
    ['Project', 'stage definition', 'planned/actual dates', 'effectivity'],
    ['Planned', 'Current', 'Completed', 'Skipped', 'Cancelled'],
    [
      'Construction Phase reuses Delivery Stage Assignment.',
      'Project lifecycle and stage assignment remain separate.'
    ]
  ),
  ...
  field(
    ...
    ['Zone reference', 'Site/spatial context', 'field applicability'],
    ['Referenced'],
    [
      'Zone is spatial/functional context, not WBS or Work Area.',
      'Temporary field overlays must not rewrite permanent spatial hierarchy.'
    ]
  ),
  ...
  field(
    ...
    [
      'Site',
      'spatial extent/Zone',
      'Project/WBS/Work Package',
      'description',
      'owner',
      'valid from/to',
      'status'
    ],
    ['Proposed', 'Active', 'Restricted', 'Closed', 'Cancelled'],
    [
      'Work Area is an operational overlay, not Site/Zone/Space identity.',
      'It may change as construction progresses without changing permanent built-environment structure.',
      'WBS and spatial extent remain orthogonal.'
    ]
  ),
  ...
  field(
    ...
    [
      ...
      'utilities/access/welfare/security',
      'actor',
      'occurred at',
      'evidence'
    ],
    ...
    [
      'This is evidence about site establishment, not Site identity.',
      'Temporary facilities/assets retain their own identities where governed.',
      'Corrections preserve prior evidence.'
    ]
  ),
  ...
  field(
    ...
    [
      ...
      'Work Area',
      'mobilisation type',
      'resources/Parties/Assets',
      'planned/actual dates',
      'actor/source',
      'evidence'
    ],
    ['Planned', 'Recorded', 'Verified', 'Corrected/Superseded'],
    [
      'Mobilisation does not create Worker, Asset or Site identities.',
      'Planned resource allocation and actual mobilisation remain distinct.',
      'Demobilisation may be represented by a typed successor occurrence.'
    ]
  ),
  ...
  field(
    ...
    [
      'subject',
      'credential',
      'Site/access point/security zone',
      'event type',
      'occurred at',
      'outcome',
      'source'
    ...
    [
      'Access Event is not Attendance or Time Entry.',
      'Credential authorisation and actual access occurrence remain separate.',
      'Security/access telemetry remains attributable evidence.'
    ]
  ),
  ...
  field(
    ...
    [
      ...
      'weather/conditions',
      'work summary',
      'labour/plant references',
      'deliveries',
      'constraints/events',
      'author',
      'evidence links'
    ],
    ['Open', 'Reviewed', 'Closed/Issued', 'Corrected/Superseded'],
    [
      'Diary is an evidence envelope, not replacement truth for Progress, Labour, Plant, Delivery, Incident or other source records.',
      'Referenced source records keep their own identity.',
      'Closed diary history is retained.'
    ]
  ),
  ...
  field(
    ...
    ['Recorded', 'Validated', 'Corrected', 'Superseded'],
    [
      'Field progress and project-controls progress use one evidence pattern.',
      'Current percent/progress is derived from retained records.'
    ]
  ),
  ...
  field(
    ...
    ['Recorded', 'Verified', 'Corrected/Superseded'],
    [
      'Field Labour Record is not Person/Worker identity.',
      'It is distinct from HCM Attendance, Time Entry and payroll truth but may reconcile to them.',
      'Subcontract labour remains linked to canonical Parties/people where known.'
    ]
  ),
  ...
  field(
    ...
    ['Recorded', 'Verified', 'Corrected/Superseded'],
    [
      'Plant Usage never creates a duplicate Plant/Asset master.',
      'Planned allocation and actual usage are separate.',
      'Usage evidence can feed cost/productivity/maintenance projections without becoming those ledgers.'
    ]
  ),
  ...
  field(
    ...
    [
      'No separate site material-consumption ledger.',
      'Posted movement is corrected by reversal/correction evidence.',
      'Cost/accounting effects remain downstream finance truth.'
    ]
  ),
  ...
  field(
    ...
    ['Recorded', 'Validated', 'Corrected/Superseded'],
    [
      'Delivery is not Goods Receipt where procurement/financial receipt semantics apply.',
      'Site logistics booking, shipment and delivery remain distinct.'
    ]
  ),
  ...
  field(
    ...
    [
      'temporary-works reference/type/category',
      'Project/Site/Work Area',
      'description/purpose',
      'design/check category',
      'responsible Parties',
      'status',
      'physical Asset/Item links'
    ],
    [
      'Identified',
      'Design Required',
    ...
    [
      'Temporary Works Control Item is not canonical Product/Material Item.',
      'It is not permanent Asset identity by default.',
      'Design/check/use evidence references exact control item and versions.'
    ]
  ),

  field(
    'FIELD-TEMPORARY-WORKS-DESIGN',
    ['BOF-12-015'],
    ...
    ['WIP', 'Review', 'Approved/Issued', 'Superseded', 'Archived'],
    [
      'Temporary Works Design reuses Information Container.',
      'Files are representations only.',
      'Checks and field use pin exact issued design revision.'
    ]
  ),

  field(
    'FIELD-TEMPORARY-WORKS-CHECK',
    ['BOF-12-016'],
    ...
    ['Planned', 'In Review', 'Comments Raised', 'Complete', 'Closed'],
    [
      'Temporary Works Check reuses Design Review.',
      'Check outcome does not silently change Information Container status.',
      'Independent-check requirements are explicit governance.'
    ]
  ),
  ...
  field(
    ...
    ['Draft', 'Ready', 'Issued', 'Active', 'Suspended', 'Handback', 'Closed', 'Cancelled'],
    [
      'Field operations and QHSE share one Permit identity.',
      'Permit is not generic workflow approval.',
      'Expired/closed permit never remains implied-active.'
    ]
  ),
  ...
  field(
    ...
    [
      'Isolation reference',
      'system/asset/energy source',
      'isolation points',
      'applied/verified by/at',
      'permit/work',
      'restoration'
    ],
    ['Planned', 'Applied', 'Verified', 'In Force', 'Released', 'Restored', 'Cancelled'],
    [
      'Field and QHSE share one Isolation identity.',
      'Isolation state is not inferred from workflow.',
      'Restoration is explicit evidence.'
    ]
  ),
  ...
  field(
    ...
    [
      ...
      'Project/Work Package/Activity',
      'Work Area',
      'subject/information revision',
      'issuer/authority',
      'issued at',
      'required action/date',
      'acknowledgement/status'
    ],
    ['Draft', 'Issued', 'Acknowledged', 'In Execution', 'Completed', 'Superseded', 'Cancelled'],
    [
      'Field Work Instruction is not automatically a contractual Instruction or Commercial Change.',
      'Any contractual/time/cost effect is explicitly linked to commercial change processes.',
      'Instruction content/version and authority basis are retained.'
    ]
  ),

  field(
    'FIELD-DELIVERY-CONSTRAINT',
    ['BOF-06-025', 'BOF-12-020'],
    'Delivery Constraint',
    'case',
    ...
    [
      'constraint type',
      'Project/WBS/Work Package/Activity',
      'Work Area/location',
      'source/basis',
      'description',
      'impact',
    ...
    ['Identified', 'Open', 'Mitigating', 'Resolved', 'Closed', 'Cancelled'],
    [
      'Field Constraint and project-controls Constraint use one canonical identity.',
      'Development Constraint remains a separate land/development concept.',
      'Closing a constraint preserves its impact/resolution evidence.'
    ]
  ),
  ...
  field(
    ...
    ['Draft', 'Approved', 'Issued', 'Completed', 'Superseded', 'Archived'],
    [
      'Field Form reuses Information Container.',
      'Binary/PDF form is a representation.',
      'Completed values/evidence must retain exact form revision.'
    ]
  ),
  ...
  field(
    ...
    ['Captured', 'Verified', 'Invalidated/Superseded'],
    [
      'Photo is evidence, not Asset/Progress/Defect truth by itself.',
      'Original capture and integrity metadata are retained.',
      'Derived annotations never erase source evidence.'
    ]
  ),

  field(
    'FIELD-GEOSPATIAL-EVIDENCE',
    ['BOF-12-023'],
    'Geospatial Evidence',
    'shared-reference',
    ...
    [
      ...
      'subject',
      'CRS',
      'coordinates/geometry/linear reference',
      'capture method/device',
      'captured at/by',
      'accuracy',
    ...
    ['Captured', 'Verified', 'Invalidated/Superseded'],
    [
      'Geospatial evidence does not create new Site/Zone/Asset identity.',
      'Coordinate reference system and accuracy are explicit.',
      'Corrections preserve source evidence/provenance.'
    ]
  ),
  ...
  field(
    ...
    [
      'Site Action reuses shared Decision Action.',
      'Workflow Work Item may coordinate it but does not replace it.',
      'Action completion never rewrites source evidence.'
    ]
  ),
  ...
  field(
    ...
    ['Recorded', 'Reviewed', 'Accepted', 'Returned', 'Corrected/Superseded'],
    [
      'Field completion is not Project closure, Contract completion, regulatory completion or Handover Acceptance.',
      'Outstanding defects/snags remain separate cases.',
      'Completion evidence may support downstream readiness/handover.'
    ]
  ),

  field(
    'FIELD-HANDOVER-READINESS',
    ['BOF-12-026'],
    'Handover Readiness Record',
    'shared-reference',
    ...
    ['Captured', 'Verified', 'Accepted', 'Rejected/Invalidated', 'Superseded'],
    [
      'Handover readiness reuses the shared readiness-evidence pattern.',
      'Readiness is not Handover Acceptance.',
      'A later readiness assessment creates new evidence rather than overwriting prior results.'
    ]
  )
];
...
export const siteFieldOperationsRelationships: SiteFieldOperationsRelationship[] = [
  {
    id: 'FIELD-R01',
    from: 'FIELD-WORK-AREA',
    predicate: 'located within',
    to: 'CBO-SITE',
    cardinality: 'many-to-one',
    governance: 'Work Area references canonical Site.'
  },
  {
    id: 'FIELD-R02',
    from: 'FIELD-WORK-AREA',
    predicate: 'may overlay',
    to: 'BE-ZONE',
    cardinality: 'many-to-many',
    governance: 'Operational area does not rewrite spatial Zone.'
  },
  {
    id: 'FIELD-R03',
    from: 'FIELD-WORK-AREA',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: 'many-to-many',
    governance: 'Spatial and WBS/work scope remain orthogonal.'
  },
  {
    id: 'FIELD-R04',
    from: 'FIELD-SITE-ESTABLISHMENT',
    predicate: 'evidences establishment at',
    to: 'CBO-SITE',
    cardinality: 'many-to-one',
    governance: 'Site identity is reused.'
  },
  {
    id: 'FIELD-R05',
    from: 'FIELD-MOBILISATION',
    predicate: 'mobilises into',
    to: 'FIELD-WORK-AREA',
    cardinality: 'many-to-zero-or-one',
    governance: 'Mobilisation occurrence and work-area context remain separate.'
  },
  {
    id: 'FIELD-R06',
    from: 'FIELD-ACCESS-EVENT',
    predicate: 'reuses',
    to: 'SEC-PHYSICAL-ACCESS-EVENT',
    cardinality: 'many-to-one-pattern',
    governance: 'Site access uses shared physical-access occurrence semantics.'
  },
  {
    id: 'FIELD-R07',
    from: 'FIELD-DAILY-DIARY',
    predicate: 'records day for',
    to: 'CBO-SITE',
    cardinality: 'many-to-one',
    governance: 'Diary never replaces Site identity.'
  },
  {
    id: 'FIELD-R08',
    from: 'FIELD-PROGRESS',
    predicate: 'reuses',
    to: 'DEL-PROGRESS-RECORD',
    cardinality: 'many-to-one-pattern',
    governance: 'One progress-evidence pattern across field and project controls.'
  },
  {
    id: 'FIELD-R09',
    from: 'FIELD-PROGRESS',
    ...
    governance: 'Progress pins exact work scope.'
  },
  {
    id: 'FIELD-R10',
    from: 'FIELD-LABOUR',
    predicate: 'may reconcile to',
    to: 'HCM-TIME-ENTRY',
    cardinality: 'many-to-many',
    governance: 'Operational and HCM/payroll time evidence remain distinct.'
  },
  {
    id: 'FIELD-R11',
    from: 'FIELD-PLANT-USAGE',
    predicate: 'uses',
    to: 'CBO-ASSET',
    cardinality: 'many-to-one',
    governance: 'Plant is canonical Asset role/type.'
  },
  {
    id: 'FIELD-R12',
    from: 'FIELD-MATERIAL-USAGE',
    predicate: 'reuses',
    to: 'INV-MOVEMENT',
    cardinality: 'many-to-one-pattern',
    governance: 'Material consumption posts through inventory movement truth.'
  },
  {
    id: 'FIELD-R13',
    from: 'FIELD-DELIVERY',
    ...
    to: 'LOG-DELIVERY',
    cardinality: 'many-to-one-pattern',
    governance: 'One delivery evidence pattern.'
  },
  {
    id: 'FIELD-R14',
    from: 'FIELD-TEMPORARY-WORKS-ITEM',
    predicate: 'located in',
    to: 'FIELD-WORK-AREA',
    cardinality: 'many-to-one-or-many',
    governance: 'Temporary works control and operational location remain separate.'
  },
  {
    id: 'FIELD-R15',
    from: 'FIELD-TEMPORARY-WORKS-DESIGN',
    predicate: 'reuses',
    to: 'CBO-INFORMATION-CONTAINER',
    cardinality: 'many-to-one-pattern',
    governance: 'Design revision/issue is controlled information.'
  },
  {
    id: 'FIELD-R16',
    from: 'FIELD-TEMPORARY-WORKS-DESIGN',
    predicate: 'defines',
    to: 'FIELD-TEMPORARY-WORKS-ITEM',
    cardinality: 'many-to-one',
    governance: 'Control item identity survives design revisions.'
  },
  {
    id: 'FIELD-R17',
    from: 'FIELD-TEMPORARY-WORKS-CHECK',
    predicate: 'reuses',
    to: 'INFO-DESIGN-REVIEW',
    cardinality: 'many-to-one-pattern',
    governance: 'Check uses shared technical review semantics.'
  },
  {
    id: 'FIELD-R18',
    from: 'FIELD-PERMIT',
    ...
    to: 'QHSE-PERMIT',
    cardinality: 'many-to-one-pattern',
    governance: 'One permit identity across QHSE and field operations.'
  },
  {
    id: 'FIELD-R19',
    from: 'FIELD-ISOLATION',
    predicate: 'reuses',
    to: 'QHSE-ISOLATION',
    cardinality: 'many-to-one-pattern',
    governance: 'One isolation identity across QHSE and field operations.'
  },
  {
    id: 'FIELD-R20',
    from: 'FIELD-WORK-INSTRUCTION',
    predicate: 'directs',
    to: 'DEL-WORK-PACKAGE',
    cardinality: 'many-to-one-or-many',
    governance: 'Instruction references exact delivery scope.'
  },
  {
    id: 'FIELD-R21',
    from: 'FIELD-DELIVERY-CONSTRAINT',
    predicate: 'constrains',
    to: 'DEL-WORK-PACKAGE',
    cardinality: 'many-to-many',
    governance: 'Constraint and work scope retain independent identities.'
  },
  {
    id: 'FIELD-R22',
    from: 'FIELD-FORM',
    ...
    to: 'CBO-INFORMATION-CONTAINER',
    cardinality: 'many-to-one-pattern',
    governance: 'Field form uses controlled information.'
  },
  {
    id: 'FIELD-R23',
    from: 'FIELD-PHOTOGRAPHIC-EVIDENCE',
    predicate: 'reuses',
    to: 'EVID-EVIDENCE-ITEM',
    cardinality: 'many-to-one-pattern',
    governance: 'Photo is typed generic evidence.'
  },
  {
    id: 'FIELD-R24',
    from: 'FIELD-GEOSPATIAL-EVIDENCE',
    predicate: 'reuses',
    to: 'EVID-EVIDENCE-ITEM',
    cardinality: 'many-to-one-pattern',
    governance: 'Geospatial capture is typed generic evidence.'
  },
  {
    id: 'FIELD-R25',
    from: 'FIELD-ACTION',
    ...
    cardinality: 'many-to-one-pattern',
    governance: 'Site actions use shared enterprise action.'
  },
  {
    id: 'FIELD-R26',
    ...
    to: 'DEL-WORK-PACKAGE',
    cardinality: 'many-to-one-or-many',
    governance: 'Completion is evidence against exact scope.'
  },
  {
    id: 'FIELD-R27',
    from: 'FIELD-HANDOVER-READINESS',
    predicate: 'reuses',
    to: 'OPS-COMMISSIONING-EVIDENCE',
    cardinality: 'many-to-one-pattern',
    governance: 'Readiness uses governed commissioning/handover evidence semantics.'
  },
  {
    id: 'FIELD-R28',
    from: 'FIELD-HANDOVER-READINESS',
    ...
    to: 'FIELD-COMPLETION',
    cardinality: 'many-to-many',
    governance: 'Readiness retains exact completion evidence basis.'
  }
];
...
export function validateSiteFieldOperationsModel() {
  ...
  const external = new Set([
    ...
    'OPS-COMMISSIONING-EVIDENCE'
  ]);
  if (
    ids.size !== siteFieldOperationsModel.length ||
    relIds.size !== siteFieldOperationsRelationships.length
  )
    return false;
  ...
  if (
    siteFieldOperationsModel.some((x) => !x.definition || !x.identityRule || !x.governance.length)
  )
    return false;
  return siteFieldOperationsRelationships.every(
