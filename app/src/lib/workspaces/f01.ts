...
export const f01Workspace = {
  ...
  areas: [
    ...
    { id: 'F01.05', name: 'Operating Model', sourceName: 'Operating model', summary: 'Define the capabilities, structures and accountabilities needed to execute strategy.', items: ['Current state', 'Target state', 'Components', 'Accountability', 'Capabilities', 'Change initiatives'] },
    { id: 'F01.06', name: 'Performance', sourceName: 'Goal & KPI management', summary: 'Set measures and targets and monitor strategic performance.', items: ['Strategic KPIs', 'Targets', 'Baselines', 'Performance data', 'Dashboards', 'Variance analysis'] },
    { id: 'F01.07', name: 'Review', sourceName: 'Strategic review', summary: 'Run controlled strategy reviews and capture resulting decisions and actions.', items: ['Review schedule', 'Review meetings', 'Review inputs', 'Actions', 'Outcomes', 'Next cycle'] },
    { id: 'F01.08', name: 'Scenario & Foresight', sourceName: 'Scenario & foresight planning', summary: 'Explore future conditions and test strategic resilience.', items: ['Scenario library', 'Baseline scenario', 'Upside / downside', 'Assumptions', 'Sensitivity analysis', 'KPI projections'] }
  ] satisfies WorkArea[],
  journey: [
    ...
    { step: '5', name: 'Publish', detail: 'Approved version becomes the active enterprise baseline.' },
