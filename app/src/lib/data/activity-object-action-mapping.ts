...
export const l2AggregateRoutes: L2AggregateRoute[] = [
  r(
    'F01-STRATEGY',
    'F01',
    'Vision|Strategic Planning|Business Planning|Operating Model',
    'AGG-02-STRATEGY',
  ...
  r(
    ...
    'AGG-02-STRATEGY',
    'SGP-ASSUMPTION',
    'Strategic Assumption / External Evidence',
    ['AGG-03-OPPORTUNITY']
  ),
  r(
    'F01-PERF',
  ...
  r(
    ...
    ['AGG-02-STRATEGY', 'AGG-27-DECISION']
  ),
  r(
    'F01-SCENARIO',
    'F01',
  ...
  r(
    ...
    ['AGG-27-DECISION', 'AGG-19-LEDGER']
  ),
  r('F02-POLICY', 'F02', 'Policy Governance', 'AGG-02-GOVERNANCE', 'SGP-POLICY', 'Policy', [
    'AGG-07-INFORMATION'
  ]),
  r(
    'F02-ETHICS',
  ...
  r(
    ...
    'Variance Management',
    'AGG-02-PERFORMANCE',
    'SGP-PERFORMANCE-OBSERVATION',
    'Performance Observation / Variance',
    ['AGG-27-DECISION']
  ),
  r(
    'F03-REVIEW',
    ...
    'SGP-GOVERNANCE-MEETING',
    'Management Review',
    ['AGG-02-PERFORMANCE', 'AGG-27-DECISION']
  ),
  r(
    'F03-BENEFIT',
    'F03',
    ...
    'AGG-02-PERFORMANCE',
    'SGP-PERFORMANCE-TARGET',
    'Benefit / Performance Target',
  ...
  r('F04-DD', 'F04', 'Due Diligence', 'AGG-22-LEGAL', 'LEGAL-MATTER', 'Due Diligence Matter', [
    'AGG-21-RISK',
    'AGG-04-DEVELOPMENT'
  ]),
  r(
    'F04-TXN',
    'F04',
    'Transaction Management|Divestiture|Strategic Partnerships',
    'AGG-04-DEVELOPMENT',
    'LDI-BUSINESS-CASE',
    'Investment / Transaction Business Case',
    ['AGG-22-LEGAL', 'AGG-19-LEDGER', 'AGG-27-DECISION']
  ),
  r(
    'F04-INTEG',
    'F04',
  ...
  r(
    'F05-PORTFOLIO',
    'F05',
    'Portfolio Strategy|Business Case Development|Innovation Management',
    'AGG-04-DEVELOPMENT',
    'LDI-BUSINESS-CASE',
  ...
  r('F05-IDEA', 'F05', 'Ideation', 'AGG-10-ITEM', 'CBO-ITEM', 'Product / Service Concept', [
    'AGG-04-DEVELOPMENT'
  ]),
  r(
    'F05-DESIGN',
    ...
    ['AGG-07-ENGINEERING-REQUIREMENTS', 'AGG-07-ENGINEERING-MODEL']
  ),
  r('F05-LAUNCH', 'F05', 'Launch Management', 'AGG-10-ITEM', 'CBO-ITEM', 'Item / Offering', [
    'AGG-03-OPPORTUNITY',
    'AGG-10-PLANNING'
  ]),
  r(
    'F05-LIFE',
    'F05',
    'Lifecycle Management|Product Retirement',
    'AGG-10-ITEM',
    'CBO-ITEM',
    'Item Lifecycle',
    ['AGG-10-CONFIGURATION']
  ...
  r(
    'F06-INTEL',
    'F06',
    'Market Intelligence|Customer Segmentation|Marketing Analytics',
    'AGG-03-OPPORTUNITY',
    'CRM-MARKET-INSIGHT',
    'Market Insight / Segment',
    ['AGG-24-DATA']
  ),
  r(
    'F06-BRAND',
  ...
  r(
    'F06-CAMPAIGN',
    'F06',
    'Campaign Management|Digital Marketing|Content Marketing|Events|Market Communications',
    'AGG-25-COMMUNICATIONS',
    'KRC-COMMS-CAMPAIGN',
    'Marketing / Communications Campaign',
    ['AGG-07-INFORMATION']
  ),
  r('F06-LEAD', 'F06', 'Lead Generation', 'AGG-03-OPPORTUNITY', 'CRM-LEAD', 'Lead', [
    'AGG-25-COMMUNICATIONS'
  ]),
  ...
  r(
    'F07-ACCOUNT',
    'F07',
    'Account Management|Channel.*Partner Sales',
    'AGG-03-OPPORTUNITY',
    'CRM-ACCOUNT-PLAN',
    'Account / Partner Plan',
    ['AGG-01-PARTY']
  ),
  r(
    'F07-OPP',
    'F07',
    'Opportunity Management|Pipeline Management|Sales Forecasting',
    'AGG-03-OPPORTUNITY',
    'CRM-OPPORTUNITY',
  ...
  r(
    ...
    'AGG-10-ITEM',
    'ITEM-PRICE-LIST',
    'Price / Commercial Definition',
    ['AGG-05-ESTIMATE']
  ),
  r('F07-QUOTE', 'F07', 'Quotation', 'AGG-05-OFFER', 'EST-QUOTATION', 'Quotation', [
    'AGG-05-ESTIMATE'
  ]),
  r('F07-BID', 'F07', 'Proposal.*Bid', 'AGG-03-PURSUIT', 'CRM-PURSUIT', 'Pursuit / Bid', [
    'AGG-05-ESTIMATE',
    'AGG-05-OFFER'
  ]),
  r('F07-CONTRACT', 'F07', 'Contract Negotiation', 'AGG-08-CONTRACT', 'CBO-CONTRACT', 'Contract', [
    'AGG-22-LEGAL'
  ]),
  r('F07-SO', 'F07', 'Sales Order Management', 'AGG-05-OFFER', 'EST-SALES-ORDER', 'Sales Order', [
    'AGG-08-CONTRACT'
  ]),
  r(
    'F07-COMP',
  ...
  r(
    'F08-CASE',
    'F08',
    'Customer Enquiry Management|Case Management|Complaint Management|Customer Feedback|Retention|Customer Success',
    'AGG-03-CUSTOMER-CASE',
    'CRM-CUSTOMER-CASE',
    'Customer Case',
    ['AGG-01-PARTY']
  ...
  r(
    ...
    'CRM-CUSTOMER-CASE',
    'Return / Refund Case',
    ['AGG-10-INVENTORY-MOVEMENT', 'AGG-19-AR']
  ),
  r('F08-WARRANTY', 'F08', 'Warranty', 'AGG-17-SERVICE', 'OPS-WARRANTY-CLAIM', 'Warranty Claim', [
  ...
  r(
    'F09-STRAT',
    'F09',
    'Procurement Strategy|Category Management|Procurement Analytics',
    'AGG-09-SOURCING',
    'COM-PROCUREMENT-PACKAGE',
    'Procurement Strategy / Package',
    ['AGG-02-PERFORMANCE']
  ),
  r(
    'F09-DISCOVERY',
    'F09',
    'Supplier Discovery|Supplier Onboarding|Supplier Relationship Management',
    'AGG-01-PARTY',
  ...
  r('F09-CONTRACT', 'F09', 'Contracting', 'AGG-08-CONTRACT', 'CBO-CONTRACT', 'Supplier Contract', [
    'AGG-09-SOURCING'
  ]),
  ...
  r('F09-RISK', 'F09', 'Supplier Risk', 'AGG-21-RISK', 'RISK-ENTERPRISE-RISK', 'Supplier Risk', [
    'AGG-01-PARTY'
  ]),
  ...
  r(
    'F10-DEMAND',
    'F10',
    'Demand Planning|Sales.*Operations Planning|Supply Planning|Material Requirements',
    'AGG-10-PLANNING',
    'PLN-DEMAND-PLAN',
    'Demand / Supply Plan',
    ['AGG-10-ITEM']
  ...
  r(
    'F10-TRANSPORT',
    'F10',
    'Transport Management|Distribution|Reverse Logistics',
    'AGG-10-LOGISTICS',
    'LOG-SHIPMENT',
    'Shipment / Logistics',
    ['AGG-10-INVENTORY-MOVEMENT']
  ...
  r(
    'F11-PLAN',
    'F11',
    'Production Planning|Production Scheduling|Capacity Management',
    'AGG-11-MFG-DEFINITION',
    'MFG-DEFINITION',
    'Manufacturing Definition / Plan',
    ['AGG-10-PLANNING']
  ),
  r(
    'F11-STAGE',
    'F11',
    'Material Staging|Packaging',
    'AGG-10-INVENTORY-MOVEMENT',
    'INV-MOVEMENT',
    'Material / Packaging Movement',
    ['AGG-11-PRODUCTION']
  ),
  r(
    'F11-EXEC',
    'F11',
    'Production Execution|Process Control|Work-in-progress|Production Reporting',
    'AGG-11-PRODUCTION',
  ...
  r(
    'F12-PLAN',
    'F12',
    'Service Planning|Service Scheduling|Service Capacity',
    'AGG-17-SERVICE',
    'OPS-SERVICE-CASE',
    'Service Case / Plan',
    ['AGG-18-WORKFORCE']
  ...
  r(
    'F13-STRAT',
    'F13',
    'Quality Strategy|Quality Planning',
    'AGG-13-QUALITY',
    'QHSE-QUALITY-PLAN',
    'Quality Plan'
  ),
  ...
  r(
    ...
    'Controlled Quality Information'
  ),
  r(
    'F13-CI',
    'F13',
  ...
  r(
    'F14-STRAT',
    'F14',
    'Financial Strategy|Budgeting|Forecasting|Profitability Analysis|Capital Expenditure',
    'AGG-19-LEDGER',
    'FIN-BUDGET',
  ...
  r(
    'F14-GL',
    'F14',
    'General Ledger|Cost Accounting|Financial Close|Consolidation|Financial Reporting|Financial Controls',
    'AGG-19-LEDGER',
    'FIN-LEDGER',
  ...
  r(
    'F14-TREASURY',
    'F14',
    'Treasury|Payments|Foreign Exchange|Debt.*Financing',
    'AGG-19-TREASURY',
    'FIN-TREASURY-DEAL',
    'Treasury / Cash',
    ['AGG-19-LEDGER']
  ...
  r('F14-TAX', 'F14', 'Tax', 'AGG-19-LEDGER', 'FIN-TAX-RETURN', 'Tax / Statutory Finance', [
  ...
  r(
    'F15-STRAT',
    'F15',
    'People Strategy|Workforce Planning|Organisation Design',
    'AGG-18-WORKFORCE',
    'HCM-WORKFORCE-PLAN',
    'Workforce Plan',
    ['AGG-01-ORG-STRUCTURE']
  ...
  r(
    'F15-ADMIN',
    'F15',
    'Employee Administration|Employee Relations|Offboarding',
    'AGG-18-WORKFORCE',
    'HCM-WORKER-RELATIONSHIP',
    'Worker Relationship / Case'
  ),
  r(
    'F15-TIME',
    'F15',
  ...
  r(
    'F16-STRAT',
    'F16',
    'IT Strategy|Enterprise Architecture|Solution Architecture',
    'AGG-24-TECHNOLOGY',
  ...
  r(
    'F16-APP',
    'F16',
    'Application Management|Software Development|DevOps|Infrastructure|Cloud Management|Network Management|Endpoint Management|IT Asset Management|Availability.*Capacity',
    'AGG-24-TECHNOLOGY',
  ...
  r(
    'F17-STRAT',
    'F17',
    'Data Strategy|Data Governance|Data Architecture',
    'AGG-24-DATA',
    'DATA-DOMAIN',
  ...
  r(
    'F17-ENGINEER',
    'F17',
    'Data Engineering|Data Platform|Metadata.*Catalogue|Data Lifecycle',
    'AGG-24-DATA',
    'DATA-PRODUCT',
  ...
  r(
    'F17-BI',
    'F17',
    'BI.*Reporting|Analytics|Data Science',
    'AGG-24-DATA',
    'ANALYTICS-MODEL',
    'Analytics / Reporting'
  ),
  r(
    'F17-AI',
    'F17',
    'AI Development|AI Governance|Model Operations',
    'AGG-24-AI',
    'AI-USE-CASE',
    'AI Use Case / Model',
    ['AGG-21-RISK']
  ...
  r(
    'F18-STRAT',
    'F18',
    'Security Strategy|Security Policy|Security Architecture|Security Compliance',
    'AGG-24-CYBER',
    'SECURITY-POLICY',
  ...
  r(
    'F18-IAM',
    'F18',
    'Identity.*Access Security|Cryptography',
    'AGG-01-AUTHORITY',
    'SEC-ACCESS-GRANT',
  ...
  r(
    'F18-VULN',
    'F18',
    'Vulnerability Management|Patch Security|Application Security',
    'AGG-24-CYBER',
    'SEC-VULNERABILITY',
    'Vulnerability / Patch'
  ),
  r(
    'F18-MON',
    'F18',
    'Security Monitoring|Threat Intelligence|Penetration Testing',
    'AGG-24-CYBER',
    'SEC-SECURITY-ALERT',
  ...
  r(
    ...
    'AGG-18-LEARNING',
    'HCM-TRAINING-COURSE',
    'Security Learning / Awareness'
  ),

  r(
    'F19-ADVICE',
    'F19',
    'Legal Advisory|Regulatory Legal|Employment Legal|Legal Spend',
    'AGG-22-LEGAL',
    'LEGAL-MATTER',
    'Legal Matter'
  ),
  ...
  r(
    ...
    'Corporate Secretariat / Entity Register',
    ['AGG-22-LEGAL']
  ),
  r(
    'F19-IP',
  ...
  r(
    'F20-RISK',
    'F20',
    'Risk Framework|Risk Identification|Risk Assessment|Risk Treatment|Risk Monitoring|Fraud Risk',
    'AGG-21-RISK',
    'RISK-ENTERPRISE-RISK',
  ...
  r(
    'F20-COMP',
    'F20',
    'Regulatory Compliance|Compliance Monitoring|Ethics.*Conduct',
    'AGG-21-CONTROL',
    'COMP-REQUIREMENT',
  ...
  r(
    'F20-CTRL',
    'F20',
    'Control Management|Control Testing',
    'AGG-21-CONTROL',
  ...
  r(
    'F20-AUDIT',
    'F20',
    'Internal Audit Planning|Audit Execution|Audit Reporting|Assurance Coordination',
    'AGG-21-AUDIT',
    'AUDIT-ENGAGEMENT',
    'Audit / Assurance'
  ),
  ...
  r(
    'F21-PROC',
    'F21',
    'Processing Inventory|Privacy Impact Assessment|International Transfers',
    'AGG-22-PRIVACY',
    'PRIV-PROCESSING-ACTIVITY',
    'Processing Activity / DPIA'
  ),
  r(
    'F21-CONSENT',
    'F21',
  ...
  r(
    'F22-ACQ',
    'F22',
    'Asset Acquisition|Property Acquisition|Construction.*Project Delivery',
    'AGG-16-SPATIAL-ASSET',
    'CBO-ASSET',
    'Asset / Property Acquisition',
    ['AGG-06-PROJECT', 'AGG-19-LEDGER']
  ),
  ...
  r('F22-DISP', 'F22', 'Asset Disposal', 'AGG-16-SPATIAL-ASSET', 'CBO-ASSET', 'Asset Disposal', [
    'AGG-28-RETENTION'
  ]),
  ...
  r(
    'F23-HS',
    'F23',
    'H&S Management|Hazard Identification|Workplace Inspections|Incident Management|Occupational Health|Permit-to-work',
    'AGG-13-INCIDENT',
    'QHSE-INCIDENT',
    'H&S / Incident / Permit',
    ['AGG-21-RISK', 'AGG-13-QUALITY']
  ),
  r(
    'F23-ENV',
    'F23',
  ...
  r(
    ...
    'Waste / Resource Evidence'
  ),
  r(
    'F23-CARBON',
    'F23',
    'Carbon Management|Energy Management|Sustainability Strategy|ESG Reporting',
    'AGG-20-CARBON',
  ...
  r(
    'F24-BCM',
    'F24',
    'Business Continuity Governance|Business Impact Analysis|Continuity Planning|Continuity Testing|Disaster Recovery Coordination',
    'AGG-23-CONTINUITY',
    'BCM-CONTINUITY-PLAN',
    'Continuity / Recovery',
    ['AGG-24-TECHNOLOGY']
  ...
  r(
    'F24-CRISIS',
    'F24',
    'Crisis Management|Emergency Response|Crisis Communications',
    'AGG-23-CRISIS',
    'BCM-CRISIS',
  ...
  r(
    'F24-PHYS',
    'F24',
    'Physical Security|Visitor Management|Security Investigations|Travel Security',
    'AGG-23-CRISIS',
    'SEC-PHYSICAL-SECURITY-INCIDENT',
    'Physical / Travel Security',
    ['AGG-01-AUTHORITY', 'AGG-18-TRAVEL']
  ),

  r(
    'F25-COMMS',
    'F25',
    'Corporate Communications|Internal Communications|Public Relations|Annual Reporting|Crisis Communications',
    'AGG-25-COMMUNICATIONS',
    'KRC-COMMS-PLAN',
  ...
  r(
    'F25-MEDIA',
    'F25',
    'Media Relations|Reputation Management|Public Affairs|Government Relations',
    'AGG-25-COMMUNICATIONS',
  ...
  r(
    'F26-KNOW',
    'F26',
    'Knowledge Strategy|Knowledge Capture|Knowledge Sharing|Knowledge Maintenance|Lessons Learned|Enterprise Search',
    'AGG-25-KNOWLEDGE',
    'KRC-KNOWLEDGE-ARTICLE',
  ...
  r(
    'F27-PORT',
    'F27',
    'Portfolio Management|Investment Governance|Programme Management',
    'AGG-06-PROJECT',
    'DEL-PORTFOLIO',
    'Portfolio / Programme',
    ['AGG-27-DECISION']
  ...
  r(
    ...
    'Project Controls',
    ['AGG-06-SCHEDULE', 'AGG-19-LEDGER']
  ),
  r('F27-PMO', 'F27', 'PMO', 'AGG-06-PROJECT', 'DEL-PORTFOLIO', 'PMO / Portfolio Governance', [
    'AGG-02-PERFORMANCE'
  ]),
  r(
    'F27-RESOURCE',
  ...
  r(
    'F28-READY',
    'F28',
    'Training.*Readiness|Adoption Management',
    'AGG-26-TRANSFORMATION',
  ...
  r(
    'F29-ARCH',
    'F29',
    'Process Architecture|Process Ownership',
    'AGG-26-PROCESS',
  ...
  r(
    'F29-MODEL',
    'F29',
    'Process Modelling|Process Redesign',
    'AGG-26-PROCESS',
    'PROC-MODEL',
  ...
  r(
    'F29-ANALYSE',
    'F29',
    'Process Analysis|Process Performance',
    'AGG-26-PROCESS',
    'PROC-ANALYSIS',
...
function inferAction(activityName: string, subfunctionName: string): ActivityAction {
  ...
  if (
    /^(define|establish|create|develop|draft|build|set up|set|capture|register|appoint|open|raise|initiate)/.test(
      value
    )
  )
    return 'create';
  if (
    /^(update|adjust|revise|maintain|change|modify|correct|improve|reprioritise|reclassify)/.test(
      value
    )
  )
    return 'change';
  ...
  if (
    /^(review|validate|verify|check|assess|evaluate|test|inspect|audit|challenge|reassess)/.test(
      value
    )
  )
    return 'review';
  if (/^(approve|authorise|authorize|accept|certify|endorse|ratify|sanction|select)/.test(value))
    return 'approve';
  ...
  if (
    /^(analyse|analyze|model|calculate|forecast|project|compare|benchmark|determine|identify|investigate|discover|map|cost|defects|hand-offs|bottlenecks)/.test(
      value
    )
  )
    return 'analyse';
...
function matchingRoutes(functionId: string, subfunctionName: string) {
  return l2AggregateRoutes.filter(
    (route) => route.functionId === functionId && route.match.test(subfunctionName)
  );
}
...
function resolveActivityTarget(
  ...
  if (subfunctionId === 'F03.02' && /^collect performance data$/i.test(activityName)) {
    ...
    subfunctionId === 'F10.07' &&
    /reconcile variance|manage adjustments/i.test(activityName)
  ) {
...
export const activityObjectActionMappings: ActivityObjectActionMapping[] =
  activitySource.subfunctions.flatMap((subfunction) => {
    ...
    return subfunction.activities.map((activityName, index) => {
      ...
      if (!aggregate)
        throw new Error(`Unknown aggregate ${target.aggregateId} for ${subfunction.id}`);
      const action = inferAction(activityName, subfunction.name);
      const approvalRequired =
        action === 'approve' || /approval|authority|certif|release|publish/i.test(activityName);
      const decisionRequired =
        approvalRequired ||
        /decid|select|adjudicat|go\/no-go|prioritis|prioritiz/i.test(activityName);
      const accessMode =
        action === 'read' || action === 'analyse' || action === 'monitor' ? 'query' : 'command';
...
export const activityObjectActionSummary = {
  ...
  mappedSubfunctionCount: new Set(activityObjectActionMappings.map((entry) => entry.subfunctionId))
    .size,
  ...
  invalidObjectModelRouteCount: activityObjectActionMappings.filter(
    (entry) => !knownSemanticModelIds.has(entry.objectModelId)
  ).length,
  invalidAggregateRouteCount: l2AggregateRoutes.filter(
    (route) => !knownAggregateIds.has(route.aggregateId)
  ).length,
  invalidObjectPlacementCount: activityObjectActionMappings.filter(
    (entry) =>
      !['root', 'owned', 'projection'].includes(
        objectPlacement(entry.aggregateId, entry.objectModelId)
      )
  ).length,
  unsafeProjectionCommandCount: activityObjectActionMappings.filter(
    (entry) =>
      objectPlacement(entry.aggregateId, entry.objectModelId) === 'projection' &&
      entry.accessMode === 'command' &&
      !['publish', 'record', 'approve'].includes(entry.action)
  ).length,
  commandCount: activityObjectActionMappings.filter((entry) => entry.accessMode === 'command')
    .length,
  queryCount: activityObjectActionMappings.filter((entry) => entry.accessMode === 'query').length,
  approvalControlledCount: activityObjectActionMappings.filter((entry) => entry.approvalRequired)
    .length,
  decisionControlledCount: activityObjectActionMappings.filter((entry) => entry.decisionRequired)
    .length,
  state: 'mapped' as const
};
...
export function validateActivityObjectActionMapping() {
  ...
  if (new Set(activityObjectActionMappings.map((entry) => entry.activityId)).size !== 1510)
    return false;
  if (!activityObjectActionMappings.every((entry) => knownAggregateIds.has(entry.aggregateId)))
    return false;
  if (
    !activityObjectActionMappings.every((entry) => knownSemanticModelIds.has(entry.objectModelId))
  )
    return false;
  if (
    !activityObjectActionMappings.every(
      (entry) => entry.writeAuthority && entry.transactionRule && entry.objectModelId
    )
  )
    return false;
