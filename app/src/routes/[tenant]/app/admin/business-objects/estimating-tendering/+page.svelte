...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed estimate identity, versioning, measurement, resource build-up, market testing,
        adjudication and customer-offer semantics without collapsing estimating into WBS,
        procurement, finance or Contract truth.
      </p>
    </div>
    <div class="hero-actions">
      ...
      <a href={`/${data.tenantSlug}/app/admin/business-objects/crm-business-development`}
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Governed estimating constructs</h2>
      </div>
      <p>
        The exact internal pricing basis remains reconstructable while downstream offers,
        commitments, WBS and accounting retain their own identities.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>From enquiry to accepted offer</h2>
      </div>
      <p>
        Shared CRM and procurement objects are reused where the meaning is genuinely shared;
        estimating-specific identities remain independently governed.
      </p>
    </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each estimatingTenderingRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
