...
<div class="page">
  <header class="hero section-card">
    <div>
      ...
      <p>
        Governed Estate, Network, Site, land/property, facility, building/infrastructure, spatial,
        system and asset semantics. The permanent built environment remains distinct from the
        Project structures used to deliver or change it.
      </p>
    </div>
  ...
  <section class="section-card model">
    <div class="section-heading">
      <div>
        ...
        <h2>Permanent built-environment identities</h2>
      </div>
      <p>
        Open a construct to inspect its identity rule, scope, lifecycle and modelling boundaries.
      </p>
    </div>
  ...
  <section class="section-card relationships">
    <div class="section-heading">
      <div>
        ...
        <h2>How spatial, physical and delivery identities connect</h2>
      </div>
  ...
  <section class="section-card rules">
    ...
    <ol>
      {#each builtEnvironmentRules as rule}<li>{rule}</li>{/each}
    </ol>
  </section>
</div>
...
<style>
  ...
  .pattern-grid article:last-child {
    border-right: 0;
  }
  .pattern-grid h2 {
    font-size: 12px;
