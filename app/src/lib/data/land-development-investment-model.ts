...
export const landDevelopmentInvestmentModel: LandDevelopmentInvestmentDefinition[] = [
  ldi(
    ...
    [
      ...
      'land/property/site context',
      'development thesis',
      'owner/sponsor',
      'indicative use/scope',
      'value/return range',
      'stage',
      'source'
    ],
    ...
    [
      'Development Opportunity is not CRM Opportunity, Project, Property or Contract identity.',
      'One opportunity may cover multiple Parcels/Properties and alternatives.',
      'Conversion/approval links downstream identities rather than renaming the opportunity.'
    ]
  ),

  ldi(
    'LDI-BUSINESS-CASE',
    ['BOF-04-002', 'BOF-04-003'],
    'Business Case',
    'case',
    ...
    [
      'Business Case is not the Decision itself.',
      'Investment approval uses shared immutable Decision evidence and applicable authority.',
      'Source appraisals/valuations/finance records remain authoritative.'
    ]
  ),
  ...
  ldi(
    ...
    [
      'Development Appraisal is decision support, not a Budget, Estimate, Property Valuation or ledger.',
      'Sensitivity/scenario runs preserve assumptions and source versions.',
  ...
  ldi(
    ...
    [
      ...
      'exercise window',
      'conditions',
      'price/valuation mechanism',
      'expiry'
    ],
    ['Draft', 'Executed', 'Effective', 'Exercisable', 'Exercised', 'Expired', 'Terminated'],
    [
      'Option reuses Contract.',
      'Option rights do not change Land Parcel or Property identity.',
      'Exercise creates explicit downstream acquisition/interest/contract effects rather than mutating the agreement into another object.'
    ]
  ),
  ...
  ldi(
    ...
    [
      'Site/Parcel/Property',
      'assessment scope',
      'planning/access/technical/environmental/legal/commercial criteria',
      'source evidence',
      'findings',
      'risks/constraints',
      'assessor',
    ...
    [
      'Site Appraisal is not Site or Land Parcel identity.',
      'Findings may create Development Constraints/Risks but do not overwrite source evidence.',
      'Resulting reports use controlled Information Container.'
    ]
  ),
  ...
  ldi(
    ...
    [
      'BOF-04 reuses BOF-16 Land Parcel.',
      'Interests and opportunities are relationships/context around the Parcel.',
      'Splits/consolidations preserve predecessor/successor traceability.'
    ]
  ),

  ldi(
    'LDI-PROPERTY-INTEREST',
    ['BOF-04-008', 'BOF-04-009', 'BOF-04-010'],
    'Property Interest',
    'relationship',
    ...
    [
      ...
      'tenure/right',
      'share/extent',
      'source instrument/title/lease',
      'valid from/to',
      'registration/reference'
    ],
    ['Proposed', 'Effective', 'Suspended/Disputed', 'Ended', 'Superseded'],
    [
      'Ownership and occupation never become fields that redefine Property/Parcel identity.',
      'Party identity is reused.',
      'Changes/transfers close/supersede relationships and preserve history.'
    ]
  ),

  ldi(
    'LDI-DEVELOPMENT-CONSTRAINT',
    ['BOF-04-011'],
    ...
    [
      'constraint type',
      'Site/Parcel/Property/opportunity scope',
      'source/basis',
      'description',
      'severity/impact',
      'owner',
    ...
    [
      'Development Constraint is distinct from Project Delivery Constraint.',
      'A constraint may predate any Project.',
      'Where delivery impact emerges, explicit mapping creates project-control context without merging identities.'
    ]
  ),

  ldi(
    'LDI-PROPERTY-VALUATION',
    ['BOF-04-012'],
    'Property Valuation',
    'valuation',
    ...
    [
      'subject Property/Parcel/Interest',
      'valuation date',
    ...
    [
      'Property Valuation is distinct from contract/payment Valuation in BOF-08.',
      'It does not rewrite Property or finance Fixed Asset identity/value automatically.',
      'Finance/investment decisions consume it through explicit references.'
    ]
  ),

  ldi(
    'LDI-LAND-PROPERTY-SURVEY',
    ['BOF-04-013'],
    ...
    [
      'Survey is evidence/work occurrence, not Land Parcel/Property identity.',
      'Reports/models/drawings use Information Container.',
      'Boundary/legal changes require explicit governed spatial/legal action rather than survey output alone.'
    ]
  ),
  ...
  ldi(
    ...
    [
      ...
      'Site/Parcel/Property',
      'proposal scope',
      'submitted information revisions',
      'submitted at',
      'status/decision'
    ],
    [
    ...
    [
      'Application is not the resulting Planning Consent.',
      'Submitted information versions are pinned and immutable as-submitted evidence.',
      'Changes after submission create governed amendment/revision history.'
    ]
  ),

  ldi(
    'LDI-PLANNING-CONSENT',
    ['BOF-04-015'],
    'Planning Consent',
    'authorization',
    ...
    [
      'Planning Consent is not generic privacy consent.',
      'Consent does not create Project/Property identity.',
      'Implementation/compliance is separately evidenced.'
    ]
  ),
  ...
  ldi(
    ...
    [
      'Planning Condition is not a standalone Plan.',
      'Discharge submissions/decisions retain exact evidence and authority provenance.',
      'Condition status never overwrites source consent wording.'
    ]
  ),

  ldi(
    'LDI-PLANNING-OBLIGATION',
    ['BOF-04-017'],
    'Planning Obligation',
    'obligation-reference',
    ...
    [
      'Legal Obligation reference',
      'planning source/basis',
      'Site/Parcel/Property',
      'Parties/authority',
      'required outcome',
      'trigger/due date',
    ...
    [
      'Planning Obligation reuses Legal Obligation.',
      'Where duty is actually contractual/regulatory, the authoritative source obligation remains that specialised type.',
      'Satisfaction is explicit evidence, not a status inferred from project completion.'
    ]
  ),

  ldi(
    'LDI-FUNDING-EVIDENCE',
    ['BOF-04-018', 'BOF-04-019'],
    'Funding Evidence',
    'event-evidence',
    ...
    [
      ...
      'Evidence does not itself create a Treasury Facility, Contract or Finance posting.',
      'Funding decisions/instruments remain authoritative in their source domains.'
    ]
  )
];
...
export const landDevelopmentInvestmentRelationships: LandDevelopmentInvestmentRelationship[] = [
  {
    id: 'LDI-R01',
    from: 'LDI-DEVELOPMENT-OPPORTUNITY',
    predicate: 'may concern',
    to: 'LDI-LAND-PARCEL',
    cardinality: 'many-to-many',
    governance: 'Opportunity context never recreates parcel identity.'
  },
  {
    id: 'LDI-R02',
    from: 'LDI-DEVELOPMENT-OPPORTUNITY',
    ...
    to: 'BE-PROPERTY',
    cardinality: 'many-to-many',
    governance: 'Property identity is reused.'
  },
  {
    id: 'LDI-R03',
    from: 'LDI-BUSINESS-CASE',
    predicate: 'supports decision on',
    to: 'LDI-DEVELOPMENT-OPPORTUNITY',
    cardinality: 'many-to-one-or-many',
    governance: 'Case and opportunity retain separate identities.'
  },
  {
    id: 'LDI-R04',
    from: 'LDI-BUSINESS-CASE',
    predicate: 'may use',
    to: 'LDI-DEVELOPMENT-APPRAISAL',
    cardinality: 'many-to-many',
    governance: 'Exact appraisal version/snapshot is retained.'
  },
  {
    id: 'LDI-R05',
    from: 'LDI-DEVELOPMENT-APPRAISAL',
    predicate: 'may use',
    to: 'LDI-PROPERTY-VALUATION',
    cardinality: 'many-to-many',
    governance: 'Property valuation remains independent professional evidence.'
  },
  {
    id: 'LDI-R06',
    from: 'LDI-LAND-OPTION',
    predicate: 'reuses',
    to: 'CBO-CONTRACT',
    cardinality: 'many-to-one-pattern',
    governance: 'Land Option is a Contract type/context.'
  },
  {
    id: 'LDI-R07',
    from: 'LDI-LAND-OPTION',
    ...
    to: 'LDI-LAND-PARCEL',
    cardinality: 'many-to-many',
    governance: 'Land rights reference exact parcels.'
  },
  {
    id: 'LDI-R08',
    from: 'LDI-PROPERTY-INTEREST',
    predicate: 'held by',
    to: 'CBO-PARTY',
    cardinality: 'many-to-one',
    governance: 'Party identity remains canonical.'
  },
  {
    id: 'LDI-R09',
    from: 'LDI-PROPERTY-INTEREST',
    ...
    governance: 'Parcel identity is not owned by the relationship.'
  },
  {
    id: 'LDI-R10',
    from: 'LDI-PROPERTY-INTEREST',
    ...
    to: 'BE-PROPERTY',
    cardinality: 'many-to-zero-or-many',
    governance: 'Property identity is stable through interest changes.'
  },
  {
    id: 'LDI-R11',
    from: 'LDI-SITE-APPRAISAL',
    predicate: 'assesses',
    to: 'CBO-SITE',
    cardinality: 'many-to-zero-or-one',
    governance: 'Site appraisal preserves exact scope/date.'
  },
  {
    id: 'LDI-R12',
    from: 'LDI-SITE-APPRAISAL',
    predicate: 'may identify',
    to: 'LDI-DEVELOPMENT-CONSTRAINT',
    cardinality: 'one-to-many',
    governance: 'Constraint is separately governed from assessment evidence.'
  },
  {
    id: 'LDI-R13',
    from: 'LDI-PROPERTY-VALUATION',
    predicate: 'values',
    to: 'BE-PROPERTY',
    cardinality: 'many-to-zero-or-one',
    governance: 'Valuation is an occurrence, not Property state.'
  },
  {
    id: 'LDI-R14',
    from: 'LDI-PROPERTY-VALUATION',
    predicate: 'may value',
    to: 'LDI-PROPERTY-INTEREST',
    cardinality: 'many-to-zero-or-one',
    governance: 'Interest scope/basis is explicit.'
  },
  {
    id: 'LDI-R15',
    from: 'LDI-LAND-PROPERTY-SURVEY',
    predicate: 'surveys',
    to: 'LDI-LAND-PARCEL',
    cardinality: 'many-to-zero-or-many',
    governance: 'Survey result does not mutate parcel boundary automatically.'
  },
  {
    id: 'LDI-R16',
    from: 'LDI-LAND-PROPERTY-SURVEY',
    ...
    cardinality: 'one-to-many',
    governance: 'Reports/drawings/models use controlled information identity.'
  },
  {
    id: 'LDI-R17',
    from: 'LDI-PLANNING-APPLICATION',
    predicate: 'applies for consent over',
    to: 'LDI-LAND-PARCEL',
    cardinality: 'many-to-many',
    governance: 'Application references exact spatial scope.'
  },
  {
    id: 'LDI-R18',
    from: 'LDI-PLANNING-APPLICATION',
    predicate: 'results in',
    to: 'LDI-PLANNING-CONSENT',
    cardinality: 'one-to-zero-or-many',
    governance: 'Consent is separate authority outcome/identity.'
  },
  {
    id: 'LDI-R19',
    from: 'LDI-PLANNING-CONSENT',
    predicate: 'contains',
    to: 'LDI-PLANNING-CONDITION',
    cardinality: 'one-to-many',
    governance: 'Condition wording/history remains subordinate to consent.'
  },
  {
    id: 'LDI-R20',
    from: 'LDI-PLANNING-OBLIGATION',
    predicate: 'reuses',
    to: 'LEGAL-OBLIGATION',
    cardinality: 'many-to-one-pattern',
    governance: 'Planning obligation uses shared legal-obligation architecture.'
  },
  {
    id: 'LDI-R21',
    from: 'LDI-FUNDING-EVIDENCE',
    predicate: 'supports',
    to: 'LDI-BUSINESS-CASE',
    cardinality: 'many-to-many',
    governance: 'Funding evidence and business case remain independent.'
  },
  {
    id: 'LDI-R22',
    from: 'LDI-BUSINESS-CASE',
    ...
    to: 'WORK-DECISION',
    cardinality: 'one-to-many',
    governance: 'Investment/governance approval is immutable shared Decision evidence.'
  },
  {
    id: 'LDI-R23',
    from: 'LDI-DEVELOPMENT-OPPORTUNITY',
    ...
    to: 'CBO-PROJECT',
    cardinality: 'one-to-zero-or-many',
    governance: 'Approved development creates/links Projects without changing opportunity identity.'
  },
  {
    id: 'LDI-R24',
    from: 'LDI-DEVELOPMENT-OPPORTUNITY',
    predicate: 'may create/acquire',
    to: 'BE-PROPERTY',
    cardinality: 'one-to-zero-or-many',
    governance: 'Property identity remains separate from opportunity.'
  }
];
...
export function validateLandDevelopmentInvestmentModel() {
  ...
  if (
    ids.size !== landDevelopmentInvestmentModel.length ||
    relIds.size !== landDevelopmentInvestmentRelationships.length
  )
    return false;
  const candidates = new Set(landDevelopmentInvestmentModel.flatMap((x) => x.candidateKeys));
  for (let i = 1; i <= 19; i += 1)
    if (!candidates.has(`BOF-04-${String(i).padStart(3, '0')}`)) return false;
  if (
    landDevelopmentInvestmentModel.some(
      (x) => !x.definition || !x.identityRule || !x.governance.length
    )
  )
    return false;
  return landDevelopmentInvestmentRelationships.every(
