...
export const sustainabilityCarbonModel: SustainabilityDefinition[] = [
  sus(
    'SUS-CARBON-METHODOLOGY',
    ['BOF-20-001'],
    'Carbon Methodology Definition',
    'controlled-definition',
    ...
    [
      'Methodology is configuration, not a carbon result.',
      'Historical assessments retain exact methodology version.'
    ]
  ),

  sus(
    'SUS-CARBON-FACTOR-SOURCE',
    ['BOF-20-002'],
    ...
    [
      'Source is not the factor value itself.',
      'Calculations pin exact source, dataset, factor and unit basis.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Published factors are immutable; corrections create successor entries.',
      'Unit and source provenance are mandatory.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Baseline is not live actual carbon truth.',
      'Later corrections never silently rewrite an approved baseline.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Carbon Budget is distinct from financial Budget and actual Carbon Assessment.',
  ...
  sus(
    ...
    [
      'Assessment is never independently editable source truth.',
      'Published results pin every source and factor version used.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Embodied Carbon Item does not become an Item master.',
      'Line provenance supports recalculation and audit.'
    ]
  ),
  ...
  sus(
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Operational energy does not duplicate meter or utility source truth.',
      'Published assessments pin exact source evidence.'
    ]
  ),
  ...
  sus(
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Operational Carbon is not Utility Consumption.',
      'Factor updates do not rewrite historic published assessments.'
    ]
  ),

  sus(
    'SUS-UTILITY-CONSUMPTION',
    ['BOF-20-010'],
    'Utility Consumption',
    'shared-reference',
    ...
    [
      'BOF-20 reuses BOF-17 Utility Consumption.',
      'Assessments consume this evidence rather than re-keying it.'
    ]
  ),
  ...
  sus(
    ...
    ['Draft', 'Active', 'Superseded', 'Retired'],
    [
      'Waste Stream is not Waste Consignment or inventory quantity.',
      'Regulatory classification/effectivity is retained.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Recovery does not destructively alter source evidence.',
      'Waste Consignment remains authoritative regulated transfer evidence where applicable.'
    ]
  ),
  ...
  sus(
    ...
    ['Recorded', 'Verified', 'Invalidated/Corrected'],
    [
      'Reuse evidence never creates a duplicate Item or Asset.',
      'Inventory and Asset movements remain governed by their source domains.'
    ]
  ),
  ...
  sus(
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Assessment is not source material-flow truth.',
      'Metrics remain reproducible from retained evidence.'
    ]
  ),
  ...
  sus(
    ...
    [
      'EPD references canonical Item and Organisation identity and does not replace either.',
      'Declared results remain tied to exact version and unit basis.'
    ]
  ),

  sus(
    'SUS-MATERIAL-PROVENANCE',
    ['BOF-20-016'],
    ...
    [
      'Item/material/lot/batch/serial',
      'origin/source Party/site',
  ...
  sus(
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Assessment does not become Supplier Party or Sourcing Evaluation identity.',
      'Procurement can consume the result without duplicating evidence.'
    ]
  ),

  sus(
    'SUS-BIODIVERSITY-MEASURE',
    ['BOF-20-018'],
    ...
    [
      'Biodiversity Measure is not Site or Land identity.',
      'Method/version and spatial boundary are mandatory.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Commitment is not evidence or achieved outcome.',
      'Contract obligations may reference it without sharing identity.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Evidence does not itself claim outcome unless methodology supports it.',
      'Beneficiary/privacy constraints are separately governed.'
    ]
  ),
  ...
  sus(
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Outcome is not independently editable source truth.',
      'Monetised outcome measures remain separate from financial ledger values.'
    ]
  ),
  ...
  sus(
    ...
    [
      'Climate Risk reuses Enterprise Risk.',
      'Risk Assessments and treatments remain shared enterprise-risk records.'
    ]
  ),
  ...
  sus(
    ...
    [
      ...
      'hazard/stressor',
      'scenario/horizon',
      'critical service/Asset/Site',
      'assessment references'
    ],
    ['Identified', 'Assessed', 'Treating', 'Monitoring', 'Closed'],
    [
      'Resilience Risk reuses Enterprise Risk.',
      'Asset/service evidence remains linked to canonical operational records.'
    ]
  ),

  sus(
    'SUS-COST-CARBON-OPTION',
    ['BOF-20-025'],
    'Cost-Carbon Option Assessment',
    'projection',
    ...
    ['Calculated', 'Reviewed', 'Published', 'Superseded'],
    [
      'Assessment is not Ledger or Estimate truth and not Carbon source truth.',
      'Trade-off weighting remains explicit.'
    ]
  )
];
...
export const sustainabilityCarbonRelationships: SustainabilityRelationship[] = [
  {
    id: 'SUS-R01',
    from: 'SUS-CARBON-FACTOR',
    predicate: 'published by',
    to: 'SUS-CARBON-FACTOR-SOURCE',
    cardinality: 'many-to-one',
    governance: 'Every factor pins source and dataset version.'
  },
  {
    id: 'SUS-R02',
    from: 'SUS-CARBON-ASSESSMENT',
    predicate: 'uses methodology',
    to: 'SUS-CARBON-METHODOLOGY',
    cardinality: 'many-to-one',
    governance: 'Exact methodology version is retained.'
  },
  {
    id: 'SUS-R03',
    from: 'SUS-CARBON-ASSESSMENT',
    ...
    governance: 'Lines are subordinate and source-linked.'
  },
  {
    id: 'SUS-R04',
    from: 'SUS-CARBON-LINE',
    predicate: 'references',
    to: 'CBO-ITEM',
    cardinality: 'many-to-zero-or-one',
    governance: 'Embodied-carbon contribution never duplicates Item.'
  },
  {
    id: 'SUS-R05',
    from: 'SUS-CARBON-LINE',
    predicate: 'uses',
    to: 'SUS-CARBON-FACTOR',
    cardinality: 'many-to-zero-or-one',
    governance: 'Exact factor and version remain auditable.'
  },
  {
    id: 'SUS-R06',
    from: 'SUS-CARBON-LINE',
    predicate: 'may use declaration',
    to: 'SUS-EPD',
    cardinality: 'many-to-zero-or-one',
    governance: 'EPD version and declared unit are retained.'
  },
  {
    id: 'SUS-R07',
    from: 'SUS-CARBON-BASELINE',
    predicate: 'baseline for',
    to: 'SUS-CARBON-TARGET',
    cardinality: 'one-to-many',
    governance: 'Target retains exact approved baseline reference.'
  },
  {
    id: 'SUS-R08',
    from: 'SUS-CARBON-BUDGET',
    predicate: 'tracks against',
    to: 'SUS-CARBON-TARGET',
    cardinality: 'many-to-one-or-many',
    governance: 'Budget remains separate from target and actual assessment.'
  },
  {
    id: 'SUS-R09',
    from: 'SUS-OP-ENERGY',
    predicate: 'derived from',
    to: 'OPS-UTILITY-CONSUMPTION',
    cardinality: 'many-to-many',
    governance: 'Consumption evidence remains authoritative.'
  },
  {
    id: 'SUS-R10',
    from: 'SUS-OP-CARBON',
    ...
    to: 'OPS-UTILITY-CONSUMPTION',
    cardinality: 'many-to-many',
    governance: 'Operational carbon references exact consumption sources.'
  },
  {
    id: 'SUS-R11',
    from: 'SUS-OP-CARBON',
    ...
    to: 'SUS-CARBON-FACTOR',
    cardinality: 'many-to-many',
    governance: 'Historical factor versions are pinned.'
  },
  {
    id: 'SUS-R12',
    from: 'SUS-RECOVERY',
    predicate: 'for stream',
    to: 'SUS-WASTE-STREAM',
    cardinality: 'many-to-one',
    governance: 'Stream classification remains separate from recovery evidence.'
  },
  {
    id: 'SUS-R13',
    from: 'SUS-RECOVERY',
    predicate: 'may reference transfer',
    to: 'QHSE-WASTE-CONSIGNMENT',
    cardinality: 'many-to-zero-or-many',
    governance: 'Regulated waste transfer evidence remains QHSE truth.'
  },
  {
    id: 'SUS-R14',
    from: 'SUS-REUSE',
    ...
    to: 'CBO-ITEM',
    cardinality: 'many-to-zero-or-one',
    governance: 'Reuse references Item identity where applicable.'
  },
  {
    id: 'SUS-R15',
    from: 'SUS-CIRCULARITY',
    predicate: 'uses',
    to: 'SUS-RECOVERY',
    cardinality: 'many-to-many',
    governance: 'Assessment derives from retained recovery evidence.'
  },
  {
    id: 'SUS-R16',
    from: 'SUS-CIRCULARITY',
    ...
    to: 'SUS-REUSE',
    cardinality: 'many-to-many',
    governance: 'Assessment derives from retained reuse evidence.'
  },
  {
    id: 'SUS-R17',
    from: 'SUS-EPD',
    predicate: 'declares for',
    to: 'CBO-ITEM',
    cardinality: 'many-to-many',
    governance: 'One Item may have multiple declaration versions or manufacturers.'
  },
  {
    id: 'SUS-R18',
    from: 'SUS-MATERIAL-PROVENANCE',
    predicate: 'describes provenance of',
    to: 'CBO-ITEM',
    cardinality: 'many-to-one',
    governance: 'Item identity remains canonical.'
  },
  {
    id: 'SUS-R19',
    from: 'SUS-RESPONSIBLE-PROCUREMENT',
    predicate: 'may reference evaluation',
    to: 'PROC-EVALUATION',
    cardinality: 'many-to-zero-or-many',
    governance: 'Sourcing evaluation and sustainability assessment remain separate evidence.'
  },
  {
    id: 'SUS-R20',
    from: 'SUS-BIODIVERSITY-MEASURE',
    predicate: 'measures scope of',
    to: 'CBO-PROJECT',
    cardinality: 'many-to-zero-or-one',
    governance: 'Project identity is reused; spatial scope may additionally apply.'
  },
  {
    id: 'SUS-R21',
    from: 'SUS-SOCIAL-EVIDENCE',
    predicate: 'supports',
    to: 'SUS-SOCIAL-COMMITMENT',
    cardinality: 'many-to-one-or-many',
    governance: 'Evidence and commitment remain separate.'
  },
  {
    id: 'SUS-R22',
    from: 'SUS-SOCIAL-OUTCOME',
    predicate: 'derived from',
    to: 'SUS-SOCIAL-EVIDENCE',
    cardinality: 'many-to-many',
    governance: 'Outcome remains reproducible from retained evidence.'
  },
  {
    id: 'SUS-R23',
    from: 'SUS-CLIMATE-RISK',
    predicate: 'reuses',
    to: 'RISK-ENTERPRISE-RISK',
    cardinality: 'many-to-one-pattern',
    governance: 'Climate risk is an Enterprise Risk classification and context.'
  },
  {
    id: 'SUS-R24',
    from: 'SUS-RESILIENCE-RISK',
    predicate: 'reuses',
    to: 'RISK-ENTERPRISE-RISK',
    cardinality: 'many-to-one-pattern',
    governance: 'Resilience risk is an Enterprise Risk classification and context.'
  },
  {
    id: 'SUS-R25',
    from: 'SUS-COST-CARBON-OPTION',
    predicate: 'compares carbon via',
    to: 'SUS-CARBON-ASSESSMENT',
    cardinality: 'many-to-many',
    governance: 'Exact carbon assessment version is referenced.'
  },
  {
    id: 'SUS-R26',
    from: 'SUS-COST-CARBON-OPTION',
    ...
    to: 'CBO-ASSET',
    cardinality: 'many-to-many',
    governance: 'Option assessment references canonical Asset where applicable.'
  }
];
...
export function validateSustainabilityCarbonModel() {
  ...
  if (
    ids.size !== sustainabilityCarbonModel.length ||
    relIds.size !== sustainabilityCarbonRelationships.length
  )
    return false;
  ...
  if (
    sustainabilityCarbonModel.some((x) => !x.definition || !x.identityRule || !x.governance.length)
  )
    return false;
  return sustainabilityCarbonRelationships.every(
