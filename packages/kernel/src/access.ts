...
export const PLATFORM_PERMISSION_KEYS = {
  ...
  RESOURCE_PLANNING_MANAGE: 'platform.resource_planning.manage',
  RESOURCE_PLANNING_FULFIL: 'platform.resource_planning.fulfil',
  ...
  CONFIGURATION_PROMOTION_READ: 'platform.configuration_promotion.read',
  CONFIGURATION_PROMOTION_MANAGE: 'platform.configuration_promotion.manage',
  CONFIGURATION_PROMOTION_APPROVE: 'platform.configuration_promotion.approve',
  CONFIGURATION_PROMOTION_EXECUTE: 'platform.configuration_promotion.execute',
  CONFIGURATION_PROMOTION_CONFLICT_DISPOSITION: 'platform.configuration_promotion.conflict_disposition',
  RECORDS_RETENTION_READ: 'platform.records_retention.read',
  RECORDS_RETENTION_MANAGE: 'platform.records_retention.manage',
  RECORDS_RETENTION_HOLD_MANAGE: 'platform.records_retention.hold_manage',
  RECORDS_RETENTION_EXECUTE: 'platform.records_retention.execute',
  RECORDS_RETENTION_DESTROY: 'platform.records_retention.destroy',
  RECORDS_RETENTION_RESTORE: 'platform.records_retention.restore',
  SUPPLIER_SOURCING_READ: 'domain.supplier_sourcing.read',
  SUPPLIER_SOURCING_MANAGE: 'domain.supplier_sourcing.manage',
  SUPPLIER_SOURCING_APPROVE: 'domain.supplier_sourcing.approve',
  SUPPLIER_SOURCING_RULE_MANAGE: 'domain.supplier_sourcing.rule_manage',
  MANUFACTURING_READ: 'domain.manufacturing.read',
  MANUFACTURING_MANAGE: 'domain.manufacturing.manage',
  MANUFACTURING_RELEASE: 'domain.manufacturing.release',
  MANUFACTURING_RESOURCE_MANAGE: 'domain.manufacturing.resource_manage',
  MANUFACTURING_CONTROL_CHARACTERISTIC_MANAGE: 'domain.manufacturing.control_characteristic_manage',
  SERVICE_DELIVERY_READ: 'domain.service_delivery.read',
  SERVICE_DELIVERY_MANAGE: 'domain.service_delivery.manage',
  SERVICE_DELIVERY_DISPATCH: 'domain.service_delivery.dispatch',
  SERVICE_DELIVERY_EXECUTE: 'domain.service_delivery.execute',
  SERVICE_DELIVERY_ACCEPT: 'domain.service_delivery.accept',
  SITE_PRODUCTION_READ: 'domain.site_production.read',
  SITE_PRODUCTION_MANAGE: 'domain.site_production.manage',
  SITE_PRODUCTION_EXECUTE: 'domain.site_production.execute',
  SITE_PRODUCTION_ISSUE_MANAGE: 'domain.site_production.issue_manage',
